...
namespace TT.Event
{
    public class TT_Event_Syzygy_Guidance : TT_Event_AEventChoiceTemplate
    {
        ...
        public override int OnChoice(TT_Event_Controller _mainEventController, TT_Player_Player _playerObject)
        {
            ...
            int guidanceGain = eventFile.GetIntValueFromEvent(_mainEventController.eventId, "guidanceGain");

            _playerObject.PerformGuidanceTransaction(guidanceGain);
        ...
        public override string GetEventChoiceDescription(TT_Event_Controller _mainEventController)
        {
            ...
            string attributeName = "guidanceChoiceName";
        ...
        public override string GetEventChoiceSecondDescription(TT_Event_Controller _mainEventController)
        {
            ...
            string attributeName = "guidanceChoiceDescription";
            string choiceDescription = eventFile.GetEventTooltipDescription(eventId, attributeName);

            int guidanceGain = eventFile.GetIntValueFromEvent(_mainEventController.eventId, "guidanceGain");

            List<DynamicStringKeyValue> dynamicStringKeyPair = new List<DynamicStringKeyValue>();
            string guidanceGainString = StringHelper.EventColorPositiveColor(guidanceGain);
            dynamicStringKeyPair.Add(new DynamicStringKeyValue("guidanceAmount", guidanceGainString));
