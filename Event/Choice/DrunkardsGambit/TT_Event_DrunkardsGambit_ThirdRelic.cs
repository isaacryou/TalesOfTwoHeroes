...
namespace TT.Event
{
    public class TT_Event_DrunkardsGambit_ThirdRelic : TT_Event_AEventChoiceTemplate
    {
        ...
        public override int OnChoice(TT_Event_Controller _mainEventController, TT_Player_Player _playerObject)
        {
            ...
            float relicChance = eventFile.GetFloatValueFromEvent(eventId, "relicChance");
            int hpLoss = eventFile.GetIntValueFromEvent(eventId, "hpLoss");
            ...
            {
                float level2RelicChance = eventFile.GetFloatValueFromEvent(eventId, "level2RelicChance");
                int relicLevel = 1;
