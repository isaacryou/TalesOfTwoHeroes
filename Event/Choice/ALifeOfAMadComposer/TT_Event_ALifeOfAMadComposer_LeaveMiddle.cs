...
namespace TT.Event
{
    public class TT_Event_ALifeOfAMadComposer_LeaveMiddle : TT_Event_AEventChoiceTemplate
    {
        ...
        public override int OnChoice(TT_Event_Controller _mainEventController, TT_Player_Player _playerObject)
        {
            ...
            int hpLost = eventFile.GetIntValueFromEvent(_mainEventController.eventId, "leaveHpLost");
