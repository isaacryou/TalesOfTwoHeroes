...
namespace TT.Event
{
    public class TT_Event_ALifeOfAMadComposer_InsanityThird : TT_Event_AEventChoiceTemplate
    {
        ...
        public override int OnChoice(TT_Event_Controller _mainEventController, TT_Player_Player _playerObject)
        {
            ...
            int relicRewardId = eventFile.GetIntValueFromEvent(_mainEventController.eventId, "relicRewardId");

            _playerObject.relicController.GrantPlayerRelicById(relicRewardId, true);
        ...
        public override string GetEventChoiceSecondDescription(TT_Event_Controller _mainEventController)
        {
            ...
            string relicName = relicFile.GetStringValueFromRelic(relicRewardId, "name");
        ...
        public override List<TT_Core_AdditionalInfoText> GetEventChoiceAdditionalInfos(TT_Event_Controller _mainEventController, TT_Player_Player _playerObject)
        {
            ...
            string insanityEnchantNameColor = StringHelper.ColorEnchantName(inanityEnchantName);
            ...
            TT_Core_AdditionalInfoText additionalInfoText = new TT_Core_AdditionalInfoText(insanityEnchantNameColor, inanityFinalDescription);
            ...
            int relicRewardId = eventFile.GetIntValueFromEvent(_mainEventController.eventId, "relicRewardId");
            GameObject relicObject = _mainEventController.relicPrefabMapping.getPrefabByRelicId(relicRewardId);
            ...
            List<TT_Core_AdditionalInfoText> relicAllAdditionalInfo = relicScript.GetAllRelicAdditionalInfo();
            if (relicAllAdditionalInfo != null)
            {
                allResults.AddRange(relicAllAdditionalInfo);
            }
