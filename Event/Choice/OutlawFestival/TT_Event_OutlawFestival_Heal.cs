...
namespace TT.Event
{
    public class TT_Event_OutlawFestival_Heal : TT_Event_AEventChoiceTemplate
    {
        ...
        public override int OnChoice(TT_Event_Controller _mainEventController, TT_Player_Player _playerObject)
        {
            ...
            int hpRecovery = eventFile.GetIntValueFromEvent(_mainEventController.eventId, "hpReocveryAmount");

            _playerObject.playerBattleObject.HealHp(hpRecovery);
            _playerObject.mainBoard.CreateBoardChangeUi(0, hpRecovery);
        ...
        public override string GetEventChoiceSecondDescription(TT_Event_Controller _mainEventController)
        {
            ...
            List<DynamicStringKeyValue> dynamicStringKeyPair = new List<DynamicStringKeyValue>();
            string hpRecoveryString = StringHelper.EventColorPositiveColor(hpRecovery);
            dynamicStringKeyPair.Add(new DynamicStringKeyValue("healAmount", hpRecoveryString));
