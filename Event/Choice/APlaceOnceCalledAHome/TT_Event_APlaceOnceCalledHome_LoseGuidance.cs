...
namespace TT.Event
{
    public class TT_Event_APlaceOnceCalledHome_LoseGuidance : TT_Event_AEventChoiceTemplate
    {
        ...
        public override int OnChoice(TT_Event_Controller _mainEventController, TT_Player_Player _playerObject)
        {
            ...
            int maxGuidanceReduction = eventFile.GetIntValueFromEvent(_mainEventController.eventId, "loseGuidanceAmount");

            _playerObject.PerformMaxGuidanceTransaction(maxGuidanceReduction * -1);
        ...
        public override string GetEventChoiceSecondDescription(TT_Event_Controller _mainEventController)
        {
            ...
            List<DynamicStringKeyValue> dynamicStringKeyPair = new List<DynamicStringKeyValue>();
            string loseGuidanceString = StringHelper.EventColorNegativeColor(maxGuidanceReduction);
            dynamicStringKeyPair.Add(new DynamicStringKeyValue("maxGuidanceAmount", loseGuidanceString));
