...
namespace TT.Event
{
    public class TT_Event_Nevermore_LoseGold : TT_Event_AEventChoiceTemplate
    {
        ...
        public override int OnChoice(TT_Event_Controller _mainEventController, TT_Player_Player _playerObject)
        {
            ...
            int goldLoss = eventFile.GetIntValueFromEvent(_mainEventController.eventId, "goldLoss");

            _playerObject.PerformShopCurrencyTransaction(goldLoss * -1);
        ...
        public override string GetEventChoiceSecondDescription(TT_Event_Controller _mainEventController)
        {
            ...
            List<DynamicStringKeyValue> dynamicStringKeyPair = new List<DynamicStringKeyValue>();
            string goldLossString = StringHelper.EventColorNegativeColor(goldLoss);
            dynamicStringKeyPair.Add(new DynamicStringKeyValue("goldAmount", goldLossString));
