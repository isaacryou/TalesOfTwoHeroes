...
namespace TT.Event
{
    public class TT_Event_ChainedGirl_LeaveWithoutRescue : TT_Event_AEventChoiceTemplate
    {
        ...
        public override string GetEventChoiceDescription(TT_Event_Controller _mainEventController)
        {
            ...
            string attributeName = "leaveWithoutRescueChoiceName";
        ...
        public override string GetEventChoiceSecondDescription(TT_Event_Controller _mainEventController)
        {
            ...
            string attributeName = "leaveWithoutRescueChoiceDescription";
