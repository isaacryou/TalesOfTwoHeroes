...
namespace TT.Potion
{
    public class TT_Potion_RemoveEnemyDefense : TT_Potion_APotionTemplate
    {
        public int potionId;
        ...
        public GameObject removeDefenseEffect;
        ...
        {
            _enemyObject.TakeDamage(-9999, true, true);
