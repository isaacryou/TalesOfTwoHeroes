...
namespace TT.Potion
{
    public class TT_Potion_Heal : TT_Potion_APotionTemplate
    {
        public int potionId;
        ...
        public override void PerformPotionEffect(TT_Potion_Controller _playerPotionController, TT_Battle_Controller _battleController, TT_Battle_Object _playerObject, TT_Battle_Object _enemyObject)
        {
            ...
            int hpRecovery = potionFileSerializer.GetIntValueFromPotion(potionId, "hpRecovery");

            _playerObject.HealHp(hpRecovery);
        ...
        public override string GetPotionDescription()
        {
            ...
            dynamicStringPair.Add(new DynamicStringKeyValue("hpRecovery", hpRecoveryString));
