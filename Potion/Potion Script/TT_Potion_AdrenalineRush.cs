...
namespace TT.Potion
{
    public class TT_Potion_AdrenalineRush : TT_Potion_APotionTemplate
    {
        public int potionId;
        ...
        public override void PerformPotionEffect(TT_Potion_Controller _playerPotionController, TT_Battle_Controller _battleController, TT_Battle_Object _playerObject, TT_Battle_Object _enemyObject)
        {
            ...
            float empoweredEffectiveness = potionFileSerializer.GetFloatValueFromPotion(potionId, "empoweredEffectiveness");

            Dictionary<string, string> statusEffectDictionary = new Dictionary<string, string>();
            statusEffectDictionary.Add("turnCount", turnCount.ToString());
            statusEffectDictionary.Add("attackUp", empoweredEffectiveness.ToString());

            _playerObject.ApplyNewStatusEffectByObject(empoweredStatusEffectObject, empoweredStatusEffectId, statusEffectDictionary);
            _playerObject.CreateBattleChangeUi(0, BattleHpChangeUiType.Normal, "", null, HpChangeDefaultStatusEffect.AttackUp);
        ...
        public override string GetPotionDescription()
        {
            ...
            float empoweredEffectiveness = potionFileSerializer.GetFloatValueFromPotion(potionId, "empoweredEffectiveness");
            string empoweredEffectivenessString = StringHelper.ColorPositiveColor(empoweredEffectiveness);
            ...
            string empoweredNameColor = StringHelper.ColorHighlightColor(empowerdName);

            List<DynamicStringKeyValue> dynamicStringPair = new List<DynamicStringKeyValue>();
            dynamicStringPair.Add(new DynamicStringKeyValue("turnCount", turnCountString));
            dynamicStringPair.Add(new DynamicStringKeyValue("empoweredEffectiveness", empoweredEffectivenessString));
            dynamicStringPair.Add(new DynamicStringKeyValue("empoweredStatusEffectName", empoweredNameColor));
