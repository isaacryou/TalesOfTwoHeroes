...
{
    public class TT_StatusEffect_OneLastWish : TT_StatusEffect_ATemplate
    {
        ...
        private int turnPassedAfterActivation;
        ...
        public override void SetUpStatusEffectVariables(int _statusEffectId, Dictionary<string, string> _statusEffectVariables)
        {
            ...
            string invincibleTurnCountString;
            if (_statusEffectVariables.TryGetValue("invincibleTurnCount", out invincibleTurnCountString))
            {
                invincibleTurnCount = int.Parse(invincibleTurnCountString) + 1;
            }
            else
            {
        ...
        public override Dictionary<string, string> GetSpecialVariables()
        {
            ...
            allSpecialVariables.Add("isEffectActive", isEffectActive.ToString());
        ...
        public override void SetSpecialVariables(Dictionary<string, string> _specialVariables)
        {
            ...
            if (_specialVariables.TryGetValue("isEffectActive", out isEffectActiveString))
            {
                isEffectActive = bool.Parse(isEffectActiveString);
            }

            string isHiddenString;
            if (_specialVariables.TryGetValue("isHidden", out isHiddenString))
            {
        ...
        public override string GetStatusEffectDescription()
        {
            ...
            string invincibleTurnCountString = StringHelper.ColorHighlightColor(invincibleTurnCount);
            dynamicStringPair.Add(new DynamicStringKeyValue("invincinbleTurnCount", invincibleTurnCountString));
            ...
            allStringPluralRule.Add(new StringPluralRule("turnPlural", invincibleTurnCount));
