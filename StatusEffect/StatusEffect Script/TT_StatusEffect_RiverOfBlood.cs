...
{
    public class TT_StatusEffect_RiverOfBlood : TT_StatusEffect_ATemplate
    {
        ...
        public override string GetStatusEffectDescription()
        {
            ...
            string damageIncreasePercentage = StringHelper.ColorPositiveColor(attackUpAmount);
            ...
            string finalDescription = StringHelper.SetDynamicString(statusEffectDescriptionToUse, dynamicStringPair);
