...
{
    public class TT_StatusEffect_RockSkin : TT_StatusEffect_ATemplate
    {
        ...
        {
            string finalVersion = statusEffectDescription;

            if (!isRemovable && statusEffectController != null)
            {
                finalVersion = statusEffectController.AddUnremovableText(finalVersion);
            }
