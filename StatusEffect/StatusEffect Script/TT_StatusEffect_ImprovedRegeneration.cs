...
{
    public class TT_StatusEffect_ImprovedRegeneration : TT_StatusEffect_ATemplate
    {
        ...
        public override void SetUpStatusEffectVariables(int _statusEffectId, Dictionary<string, string> _statusEffectVariables)
        {
            ...
            string healingEffectivenessUpString;
            if (_statusEffectVariables.TryGetValue("healingEffectivenessUp", out healingEffectivenessUpString))
            {
                healingEffectivenessUp = float.Parse(healingEffectivenessUpString, StringHelper.GetCurrentCultureInfo());
            }
            else
            {
                healingEffectivenessUp = 0;
            }
        ...
        {
            _statusEffectBattle.statusEffectHealingEffectiveness += healingEffectivenessUp;
        }
        ...
        public override string GetStatusEffectDescription()
        {
            ...
            dynamicStringPair.Add(new DynamicStringKeyValue("healingEffectivenessUp", healingEffectivenessUpString));
