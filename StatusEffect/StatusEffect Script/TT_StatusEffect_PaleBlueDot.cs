...
{
    public class TT_StatusEffect_PaleBlueDot : TT_StatusEffect_ATemplate
    {
        ...
        private int turnIncreaseTime;
        private float turnAccuracyIncreaseAmount;
        private string attackName;
        private string paleBlueDotName;
        ...
        public override void SetUpStatusEffectVariables(int _statusEffectId, Dictionary<string, string> _statusEffectVariables)
        {
            ...
            string turnAccuracyIncreaseAmountString;
            if (_statusEffectVariables.TryGetValue("turnAccuracyIncrease", out turnAccuracyIncreaseAmountString))
            {
                turnAccuracyIncreaseAmount = float.Parse(turnAccuracyIncreaseAmountString, StringHelper.GetCurrentCultureInfo());
            }
            else
            {
                turnAccuracyIncreaseAmount = 0;
            }

            attackName = statusEffectSerializer.GetStringValueFromStatusEffect(_statusEffectId, "attackName");
            paleBlueDotName = statusEffectSerializer.GetStringValueFromStatusEffect(_statusEffectId, "paleBlueDotName");
        ...
        public override Dictionary<string, string> GetSpecialVariables()
        {
            ...
            allSpecialVariables.Add("turnIncreaseTime", turnIncreaseTime.ToString());
        ...
        public override void SetSpecialVariables(Dictionary<string, string> _specialVariables)
        {
            ...
            string turnIncreaseTimeString;
            if (_specialVariables.TryGetValue("turnIncreaseTime", out turnIncreaseTimeString))
            {
                turnIncreaseTime = int.Parse(turnIncreaseTimeString);
            }
        ...
        public override string GetStatusEffectDescription()
        {
            ...
            string attackNameString = StringHelper.ColorActionName(attackName);
            dynamicStringPair.Add(new DynamicStringKeyValue("attackName", attackNameString));
            string paleBlueDotNameString = StringHelper.ColorArsenalName(paleBlueDotName);
            dynamicStringPair.Add(new DynamicStringKeyValue("paleBlueDotName", paleBlueDotNameString));
            string accuracyIncreaseString = StringHelper.ColorPositiveColor(turnIncreaseTime * turnAccuracyIncreaseAmount);
            dynamicStringPair.Add(new DynamicStringKeyValue("utilityMissChanceReduction", accuracyIncreaseString));
