...
{
    public class TT_StatusEffect_UnstablePosture : TT_StatusEffect_ATemplate
    {
        ...
        public override void SetUpStatusEffectVariables(int _statusEffectId, Dictionary<string, string> _statusEffectVariables)
        {
            ...
            string defenseGainReductionAmountString;
            if (_statusEffectVariables.TryGetValue("defenseGainReductionAmount", out defenseGainReductionAmountString))
            {
                defenseGainReductionAmount = float.Parse(defenseGainReductionAmountString, StringHelper.GetCurrentCultureInfo());
            }
            else
            {
                defenseGainReductionAmount = 0;
            }
        ...
        {
            _statusEffectBattle.statusEffectDefenseMultiplier -= defenseGainReductionAmount;
        }
        ...
        public override string GetStatusEffectDescription()
        {
            ...
            dynamicStringPair.Add(new DynamicStringKeyValue("defenseGainReductionAmount", defenseGainReductionAmountString));
            string turnCountString = StringHelper.ColorHighlightColor(turnCount);
            dynamicStringPair.Add(new DynamicStringKeyValue("defenseGainReductionTurn", turnCountString));
