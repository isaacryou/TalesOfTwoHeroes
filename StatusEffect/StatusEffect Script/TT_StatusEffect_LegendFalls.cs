...
{
    public class TT_StatusEffect_LegendFalls : TT_StatusEffect_ATemplate
    {
        ...
        private int legendFallsUsedCount;
        ...
        public override void SetUpStatusEffectVariables(int _statusEffectId, Dictionary<string, string> _statusEffectVariables)
        {
            ...
            if (_statusEffectVariables.TryGetValue("equipmentName", out equipmentName))
            {
        ...
        public override Dictionary<string, string> GetSpecialVariables()
        {
            ...
            allSpecialVariables.Add("legendFallsCount", legendFallsUsedCount.ToString());
        ...
        public override void SetSpecialVariables(Dictionary<string, string> _specialVariables)
        {
            ...
            string legendFallsUsedCountString;
            if (_specialVariables.TryGetValue("legendFallsCount", out legendFallsUsedCountString))
            {
                legendFallsUsedCount = int.Parse(legendFallsUsedCountString);
            }
        }
        ...
        public override string GetStatusEffectDescription()
        {
            ...
            string equipmentNameString = StringHelper.ColorArsenalName(equipmentName);
            dynamicStringPair.Add(new DynamicStringKeyValue("equipmentName", equipmentNameString));
            string legendFallsUsedCountString = StringHelper.ColorHighlightColor(legendFallsUsedCount);
            dynamicStringPair.Add(new DynamicStringKeyValue("decreaseTime", legendFallsUsedCountString));

            string dynamicDescription = StringHelper.SetDynamicString(statusEffectDescription, dynamicStringPair);

            List<StringPluralRule> allStringPluralRule = new List<StringPluralRule>();
            allStringPluralRule.Add(new StringPluralRule("timePlural", legendFallsUsedCount));
