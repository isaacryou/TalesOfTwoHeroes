...
{
    public class TT_StatusEffect_SureHit : TT_StatusEffect_ATemplate
    {
        ...
        private TT_StatusEffect_Battle statusEffectBattle;
        ...
        public override void SetUpStatusEffectVariables(int _statusEffectId, Dictionary<string, string> _statusEffectVariables)
        {
            ...
            dodgeStatusEffectName = statusEffectSerializer.GetStringValueFromStatusEffect(_statusEffectId, "dodgeStatusEffectName");
        ...
        {
            statusEffectBattle = _statusEffectBattle;
        }
        ...
        public override string GetStatusEffectDescription()
        {
            ...
            if (turnCount > 0)
            {
                descriptionToUse = statusEffectTurnDescription;
            }

            List<DynamicStringKeyValue> dynamicStringPair = new List<DynamicStringKeyValue>();
            string sureHitTimeString = StringHelper.ColorHighlightColor(actionCount);
            dynamicStringPair.Add(new DynamicStringKeyValue("sureHitTime", sureHitTimeString));
            string sureHitTurnString = StringHelper.ColorHighlightColor(turnCount);
            dynamicStringPair.Add(new DynamicStringKeyValue("sureHitTurns", sureHitTurnString));
            string dodgeStatusEffectNameString = StringHelper.ColorStatusEffectName(dodgeStatusEffectName);
            dynamicStringPair.Add(new DynamicStringKeyValue("dodgeStatusEffectName", dodgeStatusEffectNameString));
