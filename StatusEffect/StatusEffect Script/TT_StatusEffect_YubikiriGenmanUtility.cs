...
{
    public class TT_StatusEffect_YubikiriGenmanUtility : TT_StatusEffect_ATemplate
    {
        ...
        public override string GetStatusEffectDescription()
        {
            if (turnCount == 1)
            {
                return statusEffectSecondDescription;
            }

            List<DynamicStringKeyValue> dynamicStringPair = new List<DynamicStringKeyValue>();
            string turnCountString = StringHelper.ColorNegativeColor(turnCount);
