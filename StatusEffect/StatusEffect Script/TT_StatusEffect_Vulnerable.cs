...
{
    public class TT_StatusEffect_Vulnerable : TT_StatusEffect_ATemplate
    {
        ...
        public override void SetUpStatusEffectVariables(int _statusEffectId, Dictionary<string, string> _statusEffectVariables)
        {
            ...
            string damageIncreaseString;
            if (_statusEffectVariables.TryGetValue("damageIncrease", out damageIncreaseString))
            {
                damageIncreaseAmount = float.Parse(damageIncreaseString, StringHelper.GetCurrentCultureInfo());
            }
            else
            {
        ...
        public override string GetStatusEffectDescription()
        {
            ...
            string damageIncreasePercentage = StringHelper.ColorNegativeColor(damageIncreaseAmount);
            dynamicStringPair.Add(new DynamicStringKeyValue("damageIncrease", damageIncreasePercentage));
