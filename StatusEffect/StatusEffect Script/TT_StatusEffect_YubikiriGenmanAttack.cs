...
{
    public class TT_StatusEffect_YubikiriGenmanAttack : TT_StatusEffect_ATemplate
    {
        ...
        public override void SetUpStatusEffectVariables(int _statusEffectId, Dictionary<string, string> _statusEffectVariables)
        {
            ...
            string turnAttackString;
            if(_statusEffectVariables.TryGetValue("turnAttack", out turnAttackString))
            {
                turnAttack = int.Parse(turnAttackString);
            }
            else
            {
                turnAttack = 0;
        ...
        public override void OnTurnEnd(TT_StatusEffect_Battle _statusEffectBattle, TT_Battle_Object _battleObject, StatusEffectActionPerformed _actionTypePerformed) 
        {
            ...
            if (turnCount == 1)
            {
                _statusEffectBattle.AddStatusEffectToPerform(
                        ...
                        turnAttack * -1, //Amount of damage/defense/heal ; If none, pass in 0
        ...
        public override string GetStatusEffectDescription()
        {
            ...
            string turnAttackString = StringHelper.ColorNegativeColor(turnAttack);
            dynamicStringPair.Add(new DynamicStringKeyValue("turnAttack", turnAttackString));
