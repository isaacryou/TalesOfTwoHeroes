...
{
    public class TT_StatusEffect_Bind : TT_StatusEffect_ATemplate
    {
        public string statusEffectName;
        public string statusEffectDescription;
        public string statusEffectDescriptionTwo;
        public string statusEffectDescriptionThree;
        ...
        public override void SetUpStatusEffectVariables(int _statusEffectId, Dictionary<string, string> _statusEffectVariables)
        {
            ...
            statusEffectDescriptionTwo = statusEffectSerializer.GetStringValueFromStatusEffect(_statusEffectId, "descriptionTwo");
            statusEffectDescriptionThree = statusEffectSerializer.GetStringValueFromStatusEffect(_statusEffectId, "descriptionThree");
        ...
        public override void OnActionStart(TT_StatusEffect_Battle _statusEffectBattle, TT_Battle_Object _battleObject, StatusEffectActionPerformed _actionTypePerformed) 
        {
            ...
            if (_statusEffectBattle.statusEffectAttackBanned == false && _statusEffectBattle.statusEffectActionBanned == false && _actionTypePerformed == StatusEffectActionPerformed.Attack)
            {
                ...
                _statusEffectBattle.AddStatusEffectToPerform(
                        ...
                        -1, //Pulse live 2d : -1 = None ; 0 = Pulse self ; 1 = Against enemy ; 2 = Shake in place
                ...
                _statusEffectBattle.statusEffectAttackBanned = true;
            }
        }
        ...
        public override string GetStatusEffectDescription()
        {
            ...
            {
                descriptionToUse = statusEffectDescriptionThree;
                
            }
            else if (actionCount >= 0)
            {
                descriptionToUse = statusEffectDescriptionTwo;
            }
