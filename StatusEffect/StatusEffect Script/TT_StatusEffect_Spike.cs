...
{
    public class TT_StatusEffect_Spike : TT_StatusEffect_ATemplate
    {
        ...
        public override void SetUpStatusEffectVariables(int _statusEffectId, Dictionary<string, string> _statusEffectVariables)
        {
            ...
            string reflectionDamageString;
            if (_statusEffectVariables.TryGetValue("reflectionDamage", out reflectionDamageString))
            {
                reflectionDamage = int.Parse(reflectionDamageString);
            }
            else
            {
                reflectionDamage = 0;
        ...
        {
            _statusEffectBattle.statusEffectDamageToAttacker += reflectionDamage;
        }
        ...
        public override string GetStatusEffectDescription()
        {
            ...
            string reflectionDamageString = StringHelper.ColorNegativeColor(reflectionDamage);
            dynamicStringPair.Add(new DynamicStringKeyValue("reflectionDamage", reflectionDamageString));
