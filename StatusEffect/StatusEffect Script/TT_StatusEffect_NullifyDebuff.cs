...
{
    public class TT_StatusEffect_NullifyDebuff : TT_StatusEffect_ATemplate
    {
        ...
        private string nullifyDebuffStatusEffectName;
        ...
        public override void SetUpStatusEffectVariables(int _statusEffectId, Dictionary<string, string> _statusEffectVariables)
        {
            ...
            nullifyDebuffStatusEffectName = statusEffectSerializer.GetStringValueFromStatusEffect(_statusEffectId, "nullifyDebuffStatusEffectName");
        ...
        public override string GetStatusEffectDescription()
        {
            ...
            dynamicStringPair.Add(new DynamicStringKeyValue("nullifyDebuffAmount", actionCountString));
            ...
            string nullifyDebuffStatusEffectNameString = StringHelper.ColorStatusEffectName(nullifyDebuffStatusEffectName);
            dynamicStringPair.Add(new DynamicStringKeyValue("nullifyDebuffStatusEffectName", nullifyDebuffStatusEffectNameString));

            string dynamicDescription = StringHelper.SetDynamicString(descriptionToUse, dynamicStringPair);

            List<StringPluralRule> allStringPluralRule = new List<StringPluralRule>();
            allStringPluralRule.Add(new StringPluralRule("debuffCount", actionCount));
