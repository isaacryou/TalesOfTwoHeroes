...
{
    public class TT_StatusEffect_AttackDown : TT_StatusEffect_ATemplate
    {
        ...
        public override void SetUpStatusEffectVariables(int _statusEffectId, Dictionary<string, string> _statusEffectVariables)
        {
            ...
            string attackDownString;
            if (_statusEffectVariables.TryGetValue("attackDown", out attackDownString))
            {
                attackDownAmount = float.Parse(attackDownString, StringHelper.GetCurrentCultureInfo());
            }
            else
            {
                attackDownAmount = 0;
        ...
        public override string GetStatusEffectDescription()
        {
            ...
            string damageDecreaseString = StringHelper.ColorNegativeColor(attackDownAmount);
            dynamicStringPair.Add(new DynamicStringKeyValue("damageDecrease", damageDecreaseString));
