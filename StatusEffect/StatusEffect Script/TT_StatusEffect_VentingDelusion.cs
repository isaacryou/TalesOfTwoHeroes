...
{
    public class TT_StatusEffect_VentingDelusion : TT_StatusEffect_ATemplate
    {
        ...
        public override Dictionary<string, string> GetSpecialVariables()
        {
            ...
            allSpecialVariables.Add("statusEffectId", statusEffectId.ToString());
        ...
        public override string GetStatusEffectDescription()
        {
            ...
            dynamicStringPair.Add(new DynamicStringKeyValue("dodgeTime", actionCountString));
