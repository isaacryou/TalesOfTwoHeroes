...
{
    public class TT_StatusEffect_DamageResist : TT_StatusEffect_ATemplate
    {
        ...
        public override void SetUpStatusEffectVariables(int _statusEffectId, Dictionary<string, string> _statusEffectVariables)
        {
            ...
            string damageResistString;
            if (_statusEffectVariables.TryGetValue("damageResist", out damageResistString))
            {
                damageResistAmount = float.Parse(damageResistString, StringHelper.GetCurrentCultureInfo());
            }
            else
            {
                damageResistAmount = 0;
            }
        ...
        public override string GetStatusEffectDescription()
        {
            ...
            string damageDecreasePercentageString = StringHelper.ColorPositiveColor(damageResistAmount);
            dynamicStringPair.Add(new DynamicStringKeyValue("damageResist", damageDecreasePercentageString));
            ...
            string statusEffectDescriptionToUse = (actionCount >= 0) ? statusEffectSecondDescription : statusEffectDescription;
