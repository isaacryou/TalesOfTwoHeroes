...
{
    public class TT_StatusEffect_NewOrder : TT_StatusEffect_ATemplate
    {
        ...
        private int dropOffReductionAmount;
        private int totalDropOffReduction;
        ...
        public override void SetUpStatusEffectVariables(int _statusEffectId, Dictionary<string, string> _statusEffectVariables)
        {
            ...
            string dropOffReductionAmountString;
            if (_statusEffectVariables.TryGetValue("dropOffReductionAmount", out dropOffReductionAmountString))
            {
                dropOffReductionAmount = int.Parse(dropOffReductionAmountString);
            }
            else
            {
                dropOffReductionAmount = 0;
            }

            attackActionName = statusEffectSerializer.GetStringValueFromStatusEffect(_statusEffectId, "attackActionName");

            totalDropOffReduction = dropOffReductionAmount;
        ...
        public override Dictionary<string, string> GetSpecialVariables()
        {
            ...
            allSpecialVariables.Add("totalDropOffReduction", totalDropOffReduction.ToString());
        ...
        public override void SetSpecialVariables(Dictionary<string, string> _specialVariables)
        {
            ...
            string totalDropOffReductionString;
            if (_specialVariables.TryGetValue("totalDropOffReduction", out totalDropOffReductionString))
            {
                totalDropOffReduction = int.Parse(totalDropOffReductionString);
            }
        ...
        public override string GetStatusEffectDescription()
        {
            ...
            string totalDropOffReductionString = StringHelper.ColorPositiveColor(totalDropOffReduction);
            dynamicStringPair.Add(new DynamicStringKeyValue("defenseDamageLossReduce", totalDropOffReductionString));
            string attackActionNameString = StringHelper.ColorActionName(attackActionName);
            dynamicStringPair.Add(new DynamicStringKeyValue("attackActionName", attackActionNameString));
