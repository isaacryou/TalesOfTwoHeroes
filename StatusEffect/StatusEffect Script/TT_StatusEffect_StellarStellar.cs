...
{
    public class TT_StatusEffect_StellarStellar : TT_StatusEffect_ATemplate
    {
        ...
        private string starlightEchoActionName;
        private string starlightEchoDefenseActionName;
        private string starlightEchoName;
        private int starlightEchoBuffAmount;
        private int starlightEchoDamagePerBuff;
        ...
        public override void SetUpStatusEffectVariables(int _statusEffectId, Dictionary<string, string> _statusEffectVariables)
        {
            ...
            starlightEchoActionName = statusEffectSerializer.GetStringValueFromStatusEffect(_statusEffectId, "starlightEchoActionName");
            starlightEchoDefenseActionName = statusEffectSerializer.GetStringValueFromStatusEffect(_statusEffectId, "starlightEchoDefenseActionName");
            starlightEchoName = statusEffectSerializer.GetStringValueFromStatusEffect(_statusEffectId, "starlightEchoName");
            string starlightEchoBuffAmountString;
            if (_statusEffectVariables.TryGetValue("starlightEchoBuffAmount", out starlightEchoBuffAmountString))
            {
                starlightEchoBuffAmount = int.Parse(starlightEchoBuffAmountString);
            }
            else
            {
                starlightEchoBuffAmount = 0;
            }
            string starlightEchoDamagePerBuffString;
            if (_statusEffectVariables.TryGetValue("starlightEchoDamagePerBuff", out starlightEchoDamagePerBuffString))
            {
                starlightEchoDamagePerBuff = int.Parse(starlightEchoDamagePerBuffString);
            }
            else
            {
                starlightEchoDamagePerBuff = 0;
            }
        ...
        public override void SetSpecialVariables(Dictionary<string, string> _specialVariables)
        {
            ...
            string stellarStellarBuffAmountString;
            if (_specialVariables.TryGetValue("starlightEchoBuffAmount", out stellarStellarBuffAmountString))
            {
                starlightEchoBuffAmount = int.Parse(stellarStellarBuffAmountString);
            }
        ...
        public override string GetStatusEffectDescription()
        {
            ...
            string startlightEchoActionNameString = StringHelper.ColorActionName(starlightEchoActionName);
            dynamicStringPair.Add(new DynamicStringKeyValue("starlightEchoActionName", startlightEchoActionNameString));
            string starlightEchoDefenseActionNameString = StringHelper.ColorActionName(starlightEchoDefenseActionName);
            dynamicStringPair.Add(new DynamicStringKeyValue("starlightEchoDefenseActionName", starlightEchoDefenseActionNameString));
            string starlightEchoNameString = StringHelper.ColorArsenalName(starlightEchoName);
            dynamicStringPair.Add(new DynamicStringKeyValue("starlightEchoName", starlightEchoNameString));
            int damageIncreaseAmount = starlightEchoDamagePerBuff * starlightEchoBuffAmount;
