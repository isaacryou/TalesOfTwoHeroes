...
{
    public class TT_StatusEffect_Good : TT_StatusEffect_ATemplate
    {
        ...
        private int maxNumberOfGood;
        private float damageDecreasePerStack;
        ...
        public override void SetUpStatusEffectVariables(int _statusEffectId, Dictionary<string, string> _statusEffectVariables)
        {
            ...
            numberOfGood = statusEffectSerializer.GetIntValueFromStatusEffect(_statusEffectId, "startNumberOfStack"); ;
            damageDecreasePerStack = statusEffectSerializer.GetFloatValueFromStatusEffect(_statusEffectId, "damageDecreasePerStack");

            maxNumberOfGood = numberOfGood;
        ...
        public override Dictionary<string, string> GetSpecialVariables()
        {
            ...
            allSpecialVariables.Add("numberOfGood", numberOfGood.ToString());
            allSpecialVariables.Add("damageReduction", (numberOfGood * damageDecreasePerStack).ToString());
            allSpecialVariables.Add("maxNumberOfGood", maxNumberOfGood.ToString());
        ...
        public override void SetSpecialVariables(Dictionary<string, string> _specialVariables)
        {
            ...
            if (_specialVariables.TryGetValue("numberOfGood", out goodCountString))
            {
                numberOfGood = int.Parse(goodCountString);
            }
        ...
        public override string GetStatusEffectDescription()
        {
            ...
            string damageIncreaseString = StringHelper.ColorPositiveColor(numberOfGood * damageDecreasePerStack);
            dynamicStringPair.Add(new DynamicStringKeyValue("damageDecrease", damageIncreaseString));
            string numberOfGoodString = StringHelper.ColorHighlightColor(numberOfGood);
            dynamicStringPair.Add(new DynamicStringKeyValue("goodStackNumber", numberOfGoodString));
