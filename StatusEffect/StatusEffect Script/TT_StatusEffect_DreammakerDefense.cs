...
{
    public class TT_StatusEffect_DreammakerDefense : TT_StatusEffect_ATemplate
    {
        ...
        public override void SetUpStatusEffectVariables(int _statusEffectId, Dictionary<string, string> _statusEffectVariables)
        {
            ...
            string damageResistanceString;
            if (_statusEffectVariables.TryGetValue("damageResistance", out damageResistanceString))
            {
                damageResistance = float.Parse(damageResistanceString, StringHelper.GetCurrentCultureInfo());
            }
            else
            {
                damageResistance = 0;
        ...
        public override Dictionary<string, string> GetSpecialVariables()
        {
            ...
            allSpecialVariables.Add("damageResistance", damageResistance.ToString());
        ...
        public override void SetSpecialVariables(Dictionary<string, string> _specialVariables)
        {
            ...
            string damageResistanceString;
            if (_specialVariables.TryGetValue("damageResistance", out damageResistanceString))
            {
                damageResistance = float.Parse(damageResistanceString, StringHelper.GetCurrentCultureInfo());
            }
        ...
        {
            _statusEffectBattle.statusEffectAttackMultiplier -= damageResistance;
        }
        ...
        public override string GetStatusEffectDescription()
        {
            ...
            string damageResistanceString = (damageResistance * 100).ToString();
            dynamicStringPair.Add(new DynamicStringKeyValue("defenseDamageResistanceIncrease", damageResistanceString));
