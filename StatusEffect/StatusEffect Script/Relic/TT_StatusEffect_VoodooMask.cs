...
{
    public class TT_StatusEffect_VoodooMask : TT_StatusEffect_ATemplate
    {
        ...
        public override void OnHit(TT_StatusEffect_Battle _statusEffectBattle, TT_Battle_Object _battleObject, StatusEffectActionPerformed _actionTypePerformed)
        {
            ...
            if (allPlayerDebuff != null && allPlayerDebuff.Count > 0)
            {
                _statusEffectBattle.statusEffectAttackMultiplier -= damageReductionAmount;

                GameObject voodooMaskRelic = _battleObject.relicController.GetExistingRelic(relicId);
                TT_Relic_Relic relicScript = voodooMaskRelic.GetComponent<TT_Relic_Relic>();
        ...
        public override string GetStatusEffectDescription()
        {
            ...
            string damageResistanceAmountString = StringHelper.ColorPositiveColor(damageReductionAmount);
