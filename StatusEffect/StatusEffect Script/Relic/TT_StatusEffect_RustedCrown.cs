...
{
    public class TT_StatusEffect_RustedCrown : TT_StatusEffect_ATemplate
    {
        ...
        public override void SetUpStatusEffectVariables(int _statusEffectId, Dictionary<string, string> _statusEffectVariables)
        {
            ...
            string hpRecoveryAmountString;
            if (_statusEffectVariables.TryGetValue("hpRecoveryAmount", out hpRecoveryAmountString))
            {
                hpRecoveryAmount = int.Parse(hpRecoveryAmountString);
            }
            else
            {
                hpRecoveryAmount = 0;
        ...
        {
            BoardTile currentBoardTile = _statusEffectBattle.battleController.CurrentBoardTile;
            ...
            GameObject rustedCrownRelic = _battleObject.relicController.GetExistingRelic(relicId);
            TT_Relic_Relic relicScript = rustedCrownRelic.GetComponent<TT_Relic_Relic>();
            ...
            _statusEffectBattle.AddStatusEffectToPerform(
                        ...
                        hpRecoveryAmount, //Amount of damage/defense/heal ; If none, pass in 0
