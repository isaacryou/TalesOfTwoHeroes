...
{
    public class TT_StatusEffect_Knuckles : TT_StatusEffect_ATemplate
    {
        ...
        private float currentDamageIncrease;
        private float damageIncreaseAmount;
        private float damageIncreaseAmountMaximum;
        private bool isHidden;
        private bool actionDone;

        public int relicId;

        private int knucklesUsedCounter;
        ...
        public override void SetUpStatusEffectVariables(int _statusEffectId, Dictionary<string, string> _statusEffectVariables)
        {
            ...
            string damageIncreaseAmountMaximumString;
            if (_statusEffectVariables.TryGetValue("damageIncreaseAmountMaximum", out damageIncreaseAmountMaximumString))
            {
                damageIncreaseAmountMaximum = float.Parse(damageIncreaseAmountMaximumString, StringHelper.GetCurrentCultureInfo());
            }
            else
            {
                damageIncreaseAmountMaximum = 0;
            }

            currentDamageIncrease = 0;

            knucklesUsedCounter = 0;
        ...
        {
            _statusEffectBattle.statusEffectAttackMultiplier += currentDamageIncrease;
            ...
            if (_actionTypePerformed == StatusEffectActionPerformed.Attack)
            {
                ...
                currentDamageIncrease += damageIncreaseAmount;
                if (currentDamageIncrease > damageIncreaseAmountMaximum)
                {
                    currentDamageIncrease = damageIncreaseAmountMaximum;
                }
        ...
        public override Dictionary<string, string> GetSpecialVariables()
        {
            ...
            allSpecialVariables.Add("isHidden", (knucklesUsedCounter == 0).ToString());
            allSpecialVariables.Add("relicCounter", knucklesUsedCounter.ToString());
        ...
        public override string GetStatusEffectDescription()
        {
            ...
            string currentDamageAmountString = StringHelper.ColorPositiveColor(currentDamageIncrease);
            dynamicStringPair.Add(new DynamicStringKeyValue("damageIncreaseAmount", currentDamageAmountString));
