...
{
    public class TT_StatusEffect_Piggybank : TT_StatusEffect_ATemplate
    {
        ...
        private float rewardIncreaseAmount;
        ...
        public override void SetUpStatusEffectVariables(int _statusEffectId, Dictionary<string, string> _statusEffectVariables)
        {
            ...
            string rewardIncreaseString;
            if (_statusEffectVariables.TryGetValue("rewardIncrease", out rewardIncreaseString))
            {
                rewardIncreaseAmount = float.Parse(rewardIncreaseString, StringHelper.GetCurrentCultureInfo());
            }
            else
            {
                rewardIncreaseAmount = 0;
            }
        }
        ...
        public override Dictionary<string, string> GetSpecialVariables()
        {
            ...
            allSpecialVariables.Add("rewardIncreaseAmount", rewardIncreaseAmount.ToString());
