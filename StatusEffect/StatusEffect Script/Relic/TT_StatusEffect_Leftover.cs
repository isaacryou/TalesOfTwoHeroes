...
{
    public class TT_StatusEffect_Leftover : TT_StatusEffect_ATemplate
    {
        ...
        public override void SetUpStatusEffectVariables(int _statusEffectId, Dictionary<string, string> _statusEffectVariables)
        {
            ...
            string restoreHpString;
            if (_statusEffectVariables.TryGetValue("restoreHp", out restoreHpString))
            {
                restoreHpAmount = int.Parse(restoreHpString);
            }
            else
            {
                restoreHpAmount = 0;
        ...
        public override void OnBattleEnd(TT_StatusEffect_Battle _statusEffectBattle, TT_Battle_Object _battleObject, StatusEffectActionPerformed _actionTypePerformed)
        {
            ...
            GameObject leftoverRelic = _battleObject.relicController.GetExistingRelic(relicId);
            TT_Relic_Relic relicScript = leftoverRelic.GetComponent<TT_Relic_Relic>();
