...
{
    public class TT_StatusEffect_Kaleidoscope : TT_StatusEffect_ATemplate
    {
        ...
        {
            //If this action is utility card
            if (_actionTypePerformed == StatusEffectActionPerformed.Utility)
            {
                actionWasUtility = true;
            }
        }
        ...
        public override void OnActionEnd(TT_StatusEffect_Battle _statusEffectBattle, TT_Battle_Object _battleObject, StatusEffectActionPerformed _actionTypePerformed) 
        {
            if (actionWasUtility)
            {
                ...
                GameObject kaleidoscopeRelic = _battleObject.relicController.GetExistingRelic(relicId);
                TT_Relic_Relic relicScript = kaleidoscopeRelic.GetComponent<TT_Relic_Relic>();
