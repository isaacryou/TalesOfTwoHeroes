...
{
    public class TT_StatusEffect_AntiqueMusicSheet : TT_StatusEffect_ATemplate
    {
        ...
        private bool onBattleStartActivate;
        ...
        public override void SetUpStatusEffectVariables(int _statusEffectId, Dictionary<string, string> _statusEffectVariables)
        {
            ...
            string neededTurnCountString;
            if (_statusEffectVariables.TryGetValue("neededTurnCount", out neededTurnCountString))
            {
                neededTurnCount = int.Parse(neededTurnCountString);
            }
            else
            {
                neededTurnCount = 0;
            ...
            if (_statusEffectVariables.TryGetValue("choiceNumber", out choiceNumberString))
            {
        ...
        public override Dictionary<string, string> GetSpecialVariables()
        {
            ...
            bool isActiveCurrentTurn = (onBattleStartActivate || turnCount == neededTurnCount) ? true : false;
            allSpecialVariables.Add("isActiveCurrentTurn", isActiveCurrentTurn.ToString());
            allSpecialVariables.Add("relicCounter", turnCount.ToString());
            allSpecialVariables.Add("choiceNumber", choiceNumber.ToString());
        ...
        public override void SetSpecialVariables(Dictionary<string, string> _specialVariables)
        {
            ...
            if (_specialVariables.TryGetValue("relicCounter", out relicCounterString))
            {
                turnCount = int.Parse(relicCounterString);
            }
        }
        ...
        public override void OnTurnEnd(TT_StatusEffect_Battle _statusEffectBattle, TT_Battle_Object _battleObject, StatusEffectActionPerformed _actionTypePerformed)
        {
            ...
            GameObject antiqueMusicSheetObject = _battleObject.relicController.GetExistingRelic(relicId);
