...
{
    public class TT_StatusEffect_OldArmorSet : TT_StatusEffect_ATemplate
    {
        ...
        public override void SetUpStatusEffectVariables(int _statusEffectId, Dictionary<string, string> _statusEffectVariables)
        {
            ...
            string defenseReductionLimitString;
            if (_statusEffectVariables.TryGetValue("defenseReductionLimit", out defenseReductionLimitString))
            {
                defenseReductionLimit = int.Parse(defenseReductionLimitString);
            }
            else
            {
                defenseReductionLimit = 0;
            }
        ...
        public override string GetStatusEffectDescription()
        {
            ...
            dynamicStringPair.Add(new DynamicStringKeyValue("defenseReductionLimit", defenseReductionLimit.ToString()));
