...
{
    public class TT_StatusEffect_Helmet : TT_StatusEffect_ATemplate
    {
        ...
        public override void SetUpStatusEffectVariables(int _statusEffectId, Dictionary<string, string> _statusEffectVariables)
        {
            ...
            string defenseDefendString;
            if (_statusEffectVariables.TryGetValue("defenseDefend", out defenseDefendString))
            {
                defenseDefend = int.Parse(defenseDefendString);
            }
            else
            {
                defenseDefend = 0;
        ...
        public override void OnBattleStart(TT_StatusEffect_Battle _statusEffectBattle, TT_Battle_Object _battleObject, StatusEffectActionPerformed _actionTypePerformed) 
        {
            ...
            GameObject helmetRelic = _battleObject.relicController.GetExistingRelic(relicId);
            TT_Relic_Relic relicScript = helmetRelic.GetComponent<TT_Relic_Relic>();
            ...
            _statusEffectBattle.AddStatusEffectToPerform(
                        ...
                        defenseDefend, //Amount of damage/defense/heal ; If none, pass in 0
        ...
        public override string GetStatusEffectDescription()
        {
            ...
            dynamicStringPair.Add(new DynamicStringKeyValue("defenseDefend", defenseDefend.ToString()));
