...
{
    public class TT_StatusEffect_Omamori : TT_StatusEffect_ATemplate
    {
        ...
        public override void SetUpStatusEffectVariables(int _statusEffectId, Dictionary<string, string> _statusEffectVariables)
        {
            ...
            string damageThresholdString;
            if (_statusEffectVariables.TryGetValue("damageThreshold", out damageThresholdString))
            {
                damageThreshold = int.Parse(damageThresholdString);
            }
            else
            {
                damageThreshold = 0;
            }
            string damageReducedToString;
            if (_statusEffectVariables.TryGetValue("damageReducedTo", out damageReducedToString))
            {
                damageReducedTo = int.Parse(damageReducedToString);
            }
            else
            {
                damageReducedTo = 0;
        ...
        public override Dictionary<string, string> GetSpecialVariables()
        {
            ...
            allSpecialVariables.Add("damageThreshold", damageThreshold.ToString());
            allSpecialVariables.Add("damageReducedTo", damageReducedTo.ToString());
        ...
        public override string GetStatusEffectDescription()
        {
            ...
            dynamicStringPair.Add(new DynamicStringKeyValue("damageThreshold", damageThreshold.ToString()));
            dynamicStringPair.Add(new DynamicStringKeyValue("damageReducedTo", damageReducedTo.ToString()));
