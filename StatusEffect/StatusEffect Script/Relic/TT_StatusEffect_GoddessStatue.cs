...
{
    public class TT_StatusEffect_GoddessStatue : TT_StatusEffect_ATemplate
    {
        ...
        public override void SetUpStatusEffectVariables(int _statusEffectId, Dictionary<string, string> _statusEffectVariables)
        {
            ...
            string recoverPercentageString;
            if (_statusEffectVariables.TryGetValue("recoverPercentage", out recoverPercentageString))
            {
                recoverPercentage = float.Parse(recoverPercentageString, StringHelper.GetCurrentCultureInfo());
            }
            else
            {
                recoverPercentage = 0;
        ...
        public override Dictionary<string, string> GetSpecialVariables()
        {
            ...
            allSpecialVariables.Add("relicHasBeenUsed", relicHasBeenUsed.ToString());
            allSpecialVariables.Add("recoverPercentage", recoverPercentage.ToString());
