...
{
    public class TT_StatusEffect_LifeDrain : TT_StatusEffect_ATemplate
    {
        ...
        public override void SetUpStatusEffectVariables(int _statusEffectId, Dictionary<string, string> _statusEffectVariables)
        {
            ...
            hpRecover = statusEffectSerializer.GetIntValueFromStatusEffect(_statusEffectId, "hpRecover");
        }
        ...
        public override string GetStatusEffectDescription()
        {
            ...
            if (gameObject.scene.name == null)
            {
                ...
                statusEffectDescription = statusEffectSerializer.GetStringValueFromStatusEffect(90, "description");
                hpRecover = statusEffectSerializer.GetIntValueFromStatusEffect(90, "hpRecover");
            }

            List<DynamicStringKeyValue> dynamicStringPair = new List<DynamicStringKeyValue>();
            string hpRecoverString = StringHelper.ColorPositiveColor(hpRecover);
            dynamicStringPair.Add(new DynamicStringKeyValue("hpRecover", hpRecoverString));
        ...
        public override string GetStatusEffectName()
        {
            if (gameObject.scene.name == null)
            {
                ...
                statusEffectName = statusEffectSerializer.GetStringValueFromStatusEffect(90, "name");
            }
