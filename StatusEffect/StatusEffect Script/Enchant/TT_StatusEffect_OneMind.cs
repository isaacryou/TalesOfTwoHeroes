...
{
    public class TT_StatusEffect_OneMind : TT_StatusEffect_ATemplate
    {
        ...
        public override void SetUpStatusEffectVariables(int _statusEffectId, Dictionary<string, string> _statusEffectVariables)
        {
            ...
            attackUpAmount = statusEffectSerializer.GetFloatValueFromStatusEffect(_statusEffectId, "attackIncrease");
        }
        ...
        public override string GetStatusEffectDescription()
        {
            ...
            if (gameObject.scene.name == null)
            {
                ...
                statusEffectDescription = statusEffectSerializer.GetStringValueFromStatusEffect(57, "description");
                attackUpAmount = statusEffectSerializer.GetFloatValueFromStatusEffect(57, "attackIncrease");
            }
        ...
        public override string GetStatusEffectName()
        {
            if (gameObject.scene.name == null)
            {
                ...
                statusEffectName = statusEffectSerializer.GetStringValueFromStatusEffect(57, "name");
            }
