...
{
    public class TT_StatusEffect_Anarchy : TT_StatusEffect_ATemplate
    {
        ...
        public override string GetStatusEffectDescription()
        {
            ...
            if (gameObject.scene.name == null)
            {
                ...
                statusEffectDescription = statusEffectSerializer.GetStringValueFromStatusEffect(124, "description");

                increaseDamage = statusEffectSerializer.GetFloatValueFromStatusEffect(124, "increaseDamage");
                increaseDefense = statusEffectSerializer.GetFloatValueFromStatusEffect(124, "increaseDefense");
                selfDamage = statusEffectSerializer.GetIntValueFromStatusEffect(124, "selfDamage");
            }
            ...
            string selfDamageString = StringHelper.ColorNegativeColor(selfDamage);
            ...
            dynamicStringPair.Add(new DynamicStringKeyValue("selfDamage", selfDamageString));
        ...
        public override string GetStatusEffectName()
        {
            if (gameObject.scene.name == null)
            {
                ...
                statusEffectName = statusEffectSerializer.GetStringValueFromStatusEffect(124, "name");
            }
