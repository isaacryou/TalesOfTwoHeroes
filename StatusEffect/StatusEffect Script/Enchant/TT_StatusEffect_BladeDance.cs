...
{
    public class TT_StatusEffect_BladeDance : TT_StatusEffect_ATemplate
    {
        ...
        public override void SetUpStatusEffectVariables(int _statusEffectId, Dictionary<string, string> _statusEffectVariables)
        {
            ...
            attackUpAmount = statusEffectSerializer.GetFloatValueFromStatusEffect(_statusEffectId, "attackDamageIncrease");
            neededTurnCount = statusEffectSerializer.GetIntValueFromStatusEffect(_statusEffectId, "turnCount");
        }
        ...
        public override void OnAttack(TT_StatusEffect_Battle _statusEffectBattle, TT_Battle_Object _battleObject, StatusEffectActionPerformed _actionTypePerformed) 
        {
            ...
            int currentTurn = _battleObject.battleController.TurnCount;
            if (currentTurn < neededTurnCount)
            {
                return;
            }
        ...
        public override string GetStatusEffectDescription()
        {
            ...
            if (gameObject.scene.name == null)
            {
                ...
                statusEffectDescription = statusEffectSerializer.GetStringValueFromStatusEffect(120, "description");
                attackUpAmount = statusEffectSerializer.GetFloatValueFromStatusEffect(120, "attackDamageIncrease");
                neededTurnCount = statusEffectSerializer.GetIntValueFromStatusEffect(120, "turnCount");
            }
            ...
            dynamicStringPair.Add(new DynamicStringKeyValue("turnCount", neededTurnCount.ToString()));
        ...
        public override string GetStatusEffectName()
        {
            if (gameObject.scene.name == null)
            {
                ...
                statusEffectName = statusEffectSerializer.GetStringValueFromStatusEffect(120, "name");
            }
