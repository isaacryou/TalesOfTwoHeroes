...
{
    public class TT_StatusEffect_Frenzy : TT_StatusEffect_ATemplate
    {
        ...
        public override void OnAttack(TT_StatusEffect_Battle _statusEffectBattle, TT_Battle_Object _battleObject, StatusEffectActionPerformed _actionTypePerformed) 
        {
            if (_statusEffectBattle.usedEquipment.GetInstanceID() == equipmentUniqueId)
            {
                ...
                _statusEffectBattle.statusEffectDefenseMultiplier -= 100;
            }
        }
        ...
        public override string GetStatusEffectDescription()
        {
            ...
            if (gameObject.scene.name == null)
            {
                ...
                statusEffectDescription = statusEffectSerializer.GetStringValueFromStatusEffect(97, "description");
                attackUpAmount = statusEffectSerializer.GetFloatValueFromStatusEffect(97, "increaseDamage");
            }
        ...
        public override string GetStatusEffectName()
        {
            if (gameObject.scene.name == null)
            {
                ...
                statusEffectName = statusEffectSerializer.GetStringValueFromStatusEffect(97, "name");
            }
