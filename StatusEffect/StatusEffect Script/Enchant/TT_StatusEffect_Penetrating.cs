...
{
    public class TT_StatusEffect_Penetrating : TT_StatusEffect_ATemplate
    {
        ...
        public override void OnAttack(TT_StatusEffect_Battle _statusEffectBattle, TT_Battle_Object _battleObject, StatusEffectActionPerformed _actionTypePerformed) 
        {
            if (_statusEffectBattle.usedEquipment.GetInstanceID() == equipmentUniqueId)
            {
                ...
                if (enemyObject.GetCurDefenseValue() <= 0)
                {
                    return;
                }
        ...
        public override string GetStatusEffectDescription()
        {
            ...
            if (gameObject.scene.name == null)
            {
                ...
                statusEffectDescription = statusEffectSerializer.GetStringValueFromStatusEffect(98, "description");
                attackUpAmount = statusEffectSerializer.GetFloatValueFromStatusEffect(98, "increaseDamage");
            }
        ...
        public override string GetStatusEffectName()
        {
            if (gameObject.scene.name == null)
            {
                ...
                statusEffectName = statusEffectSerializer.GetStringValueFromStatusEffect(98, "name");
            }
