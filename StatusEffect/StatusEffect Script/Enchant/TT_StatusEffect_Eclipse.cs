...
{
    public class TT_StatusEffect_Eclipse : TT_StatusEffect_ATemplate
    {
        ...
        public override string GetStatusEffectDescription()
        {
            ...
            if (gameObject.scene.name == null)
            {
                ...
                statusEffectDescription = statusEffectSerializer.GetStringValueFromStatusEffect(123, "description");

                decreaseDamage = statusEffectSerializer.GetFloatValueFromStatusEffect(123, "decreaseDamage");
                decreaseDefense = statusEffectSerializer.GetFloatValueFromStatusEffect(123, "decreaseDefense");
                increaseDamage = statusEffectSerializer.GetFloatValueFromStatusEffect(123, "increaseDamage");
                increaseDefense = statusEffectSerializer.GetFloatValueFromStatusEffect(123, "increaseDefense");
            }

            List<DynamicStringKeyValue> dynamicStringPair = new List<DynamicStringKeyValue>();
            string decreaseDamageStringColor = StringHelper.ColorNegativeColor(decreaseDamage);
            string decreaseDefenseStringColor = StringHelper.ColorNegativeColor(decreaseDefense);
            string increaseDamageStringColor = StringHelper.ColorPositiveColor(increaseDamage);
            string increaseDefenseStringColor = StringHelper.ColorPositiveColor(increaseDefense);
            dynamicStringPair.Add(new DynamicStringKeyValue("decreaseDamage", decreaseDamageStringColor));
            dynamicStringPair.Add(new DynamicStringKeyValue("decreaseDefense", decreaseDefenseStringColor));
            dynamicStringPair.Add(new DynamicStringKeyValue("increaseDamage", increaseDamageStringColor));
            dynamicStringPair.Add(new DynamicStringKeyValue("increaseDefense", increaseDefenseStringColor));
        ...
        public override string GetStatusEffectName()
        {
            if (gameObject.scene.name == null)
            {
                ...
                statusEffectName = statusEffectSerializer.GetStringValueFromStatusEffect(123, "name");
            }
