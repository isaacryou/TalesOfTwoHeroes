...
{
    public class TT_StatusEffect_JackInTheBox : TT_StatusEffect_ATemplate
    {
        ...
        public override void SetUpStatusEffectVariables(int _statusEffectId, Dictionary<string, string> _statusEffectVariables)
        {
            ...
            disableChance = statusEffectSerializer.GetFloatValueFromStatusEffect(statusEffectId, "disableChance");

            TT_StatusEffect_ASpecialBehaviour specialBehaviour = gameObject.GetComponent<TT_StatusEffect_ASpecialBehaviour>();
            Dictionary<string, string> specialBehaviourVariables = new Dictionary<string, string>();
            specialBehaviourVariables.Add("equipmentUniqueId", equipmentUniqueId.ToString());
            specialBehaviourVariables.Add("disableChance", disableChance.ToString());
            specialBehaviour.SetSpecialVariables(specialBehaviourVariables);
        }
        ...
        public override Dictionary<string, string> GetSpecialVariables()
        {
            ...
            allSpecialVariables.Add("disableChance", disableChance.ToString());
        ...
        public override string GetStatusEffectDescription()
        {
            ...
            if (gameObject.scene.name == null)
            {
                ...
                statusEffectDescription = statusEffectSerializer.GetStringValueFromStatusEffect(128, "description");
            }
        ...
        public override string GetStatusEffectName()
        {
            if (gameObject.scene.name == null)
            {
                ...
                statusEffectName = statusEffectSerializer.GetStringValueFromStatusEffect(128, "name");
            }
