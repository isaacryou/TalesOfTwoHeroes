...
{
    public class TT_StatusEffect_Fragile : TT_StatusEffect_ATemplate
    {
        ...
        private float attackDownAmount;
        ...
        public override void SetUpStatusEffectVariables(int _statusEffectId, Dictionary<string, string> _statusEffectVariables)
        {
            ...
            attackDownAmount = statusEffectSerializer.GetFloatValueFromStatusEffect(_statusEffectId, "decreaseDamage");
        }
        ...
        public override void OnAttack(TT_StatusEffect_Battle _statusEffectBattle, TT_Battle_Object _battleObject, StatusEffectActionPerformed _actionTypePerformed) 
        {
            ...
            {
                _statusEffectBattle.statusEffectAttackMultiplier -= attackDownAmount;
            }
        }
        ...
        public override string GetStatusEffectDescription()
        {
            ...
            if (gameObject.scene.name == null)
            {
                ...
                statusEffectDescription = statusEffectSerializer.GetStringValueFromStatusEffect(92, "description");
                attackDownAmount = statusEffectSerializer.GetFloatValueFromStatusEffect(92, "decreaseDamage");
            }

            List<DynamicStringKeyValue> dynamicStringPair = new List<DynamicStringKeyValue>();
            string attackDownAmountString = StringHelper.ColorNegativeColor(attackDownAmount);
            dynamicStringPair.Add(new DynamicStringKeyValue("decreaseDamage", attackDownAmountString));
        ...
        public override string GetStatusEffectName()
        {
            if (gameObject.scene.name == null)
            {
                ...
                statusEffectName = statusEffectSerializer.GetStringValueFromStatusEffect(92, "name");
            }
