...
{
    public class TT_StatusEffect_QuickAttack : TT_StatusEffect_ATemplate
    {
        ...
        public override void SetUpStatusEffectVariables(int _statusEffectId, Dictionary<string, string> _statusEffectVariables)
        {
            ...
            maxTurnCount = statusEffectSerializer.GetIntValueFromStatusEffect(_statusEffectId, "turnCount");
        }
        ...
        public override string GetStatusEffectDescription()
        {
            ...
            if (gameObject.scene.name == null)
            {
                ...
                statusEffectDescription = statusEffectSerializer.GetStringValueFromStatusEffect(121, "description");
                attackUpAmount = statusEffectSerializer.GetFloatValueFromStatusEffect(121, "attackDamageIncrease");
                maxTurnCount = statusEffectSerializer.GetIntValueFromStatusEffect(121, "turnCount");
            }

            List<DynamicStringKeyValue> dynamicStringPair = new List<DynamicStringKeyValue>();
            string attackUpAmountString = StringHelper.ColorPositiveColor(attackUpAmount);
            string turnCountString = StringHelper.ColorHighlightColor(maxTurnCount);
            ...
            allStringPluralRule.Add(new StringPluralRule("turnPlural", maxTurnCount));
        ...
        public override string GetStatusEffectName()
        {
            if (gameObject.scene.name == null)
            {
                ...
                statusEffectName = statusEffectSerializer.GetStringValueFromStatusEffect(121, "name");
            }
