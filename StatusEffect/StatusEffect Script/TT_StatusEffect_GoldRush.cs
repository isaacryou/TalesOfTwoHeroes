...
{
    public class TT_StatusEffect_GoldRush : TT_StatusEffect_ATemplate
    {
        ...
        private float goldIncreaseAmount;

        private string potionDescriptionString;
        ...
        public override void SetUpStatusEffectVariables(int _statusEffectId, Dictionary<string, string> _statusEffectVariables)
        {
            ...
            string goldIncreaseAmountString;
            if (_statusEffectVariables.TryGetValue("goldIncreaseAmount", out goldIncreaseAmountString))
            {
                goldIncreaseAmount = float.Parse(goldIncreaseAmountString, StringHelper.GetCurrentCultureInfo());
            }
            else
            {
            ...
            if (_statusEffectVariables.TryGetValue("goldDesription", out potionDescriptionString))
            {
            }
        ...
        public override Dictionary<string, string> GetSpecialVariables()
        {
            ...
            allSpecialVariables.Add("goldIncreaseAmount", goldIncreaseAmount.ToString());
        ...
        public override string GetStatusEffectDescription()
        {
            ...
            string descriptionToUse = potionDescriptionString;
