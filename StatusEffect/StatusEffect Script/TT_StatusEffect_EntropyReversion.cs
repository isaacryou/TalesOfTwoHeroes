...
{
    public class TT_StatusEffect_EntropyReversion : TT_StatusEffect_ATemplate
    {
        ...
        public override void SetUpStatusEffectVariables(int _statusEffectId, Dictionary<string, string> _statusEffectVariables)
        {
            ...
            if (_statusEffectVariables.TryGetValue("attackDamageIncrease", out attackDamageString))
            {
                attackDamageIncrease = float.Parse(attackDamageString, StringHelper.GetCurrentCultureInfo());
            }
            else
            {
        ...
        {
            _statusEffectBattle.statusEffectAttackMultiplier += attackDamageIncrease;
        }
        ...
        public override void OnTurnEnd(TT_StatusEffect_Battle _statusEffectBattle, TT_Battle_Object _battleObject, StatusEffectActionPerformed _actionTypePerformed) 
        {
            ...
            if (turnCount <= 0)
            {
                ...
                _statusEffectBattle.AddStatusEffectToPerform(
                        ...
                        9999 * -1, //Amount of damage/defense/heal ; If none, pass in 0
        ...
        public override string GetStatusEffectDescription()
        {
            ...
            string damageIncreasePercentageString = StringHelper.ColorPositiveColor(attackDamageIncrease);
            dynamicStringPair.Add(new DynamicStringKeyValue("damageIncrease", damageIncreasePercentageString));
