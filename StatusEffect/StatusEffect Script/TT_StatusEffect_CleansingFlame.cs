...
{
    public class TT_StatusEffect_CleansingFlame : TT_StatusEffect_ATemplate
    {
        ...
        public override void SetUpStatusEffectVariables(int _statusEffectId, Dictionary<string, string> _statusEffectVariables)
        {
            ...
            string explosionDamageString;
            if (_statusEffectVariables.TryGetValue("explosionDamage", out explosionDamageString))
            {
                explosionDamage = int.Parse(explosionDamageString);
            }
            else
            {
                explosionDamage = 0;
        ...
        public override void OnTurnEnd(TT_StatusEffect_Battle _statusEffectBattle, TT_Battle_Object _battleObject, StatusEffectActionPerformed _actionTypePerformed) 
        {
            if (turnCount == 1)
            {
                ...
                _statusEffectBattle.AddStatusEffectToPerform(
                    ...
                    explosionDamage * -1, //Amount of damage/defense/heal ; If none, pass in 0
                    ...
                    -1, //Pulse live 2d : -1 = None ; 0 = Pulse self ; 1 = Against enemy
        ...
        { 
            if (actionCount <= 0)
            {
                ...
                TT_Battle_Object opponentObject = _battleObject.GetCurrentOpponent();

                _statusEffectBattle.AddStatusEffectToPerform(
                    StatusEffectActions.OnActionEnd, //StatusEffectAction
                    statusEffectId, //Status effect id
                    opponentObject, //Battle object
                    explosionDamage * -1, //Amount of damage/defense/heal ; If none, pass in 0
                    null, //Text to show ; If none, pass in null
                    statusEffectUi, //Effect to play
                    BattleHpChangeUiType.Damage, //Battle HP change UI Type to determine the icon and color used to display damage/defense/heal
        ...
        public override string GetStatusEffectDescription()
        {
            ...
            int actionCountToDisplay = (actionCount > 0) ? actionCount : 0;
            string actionCountToDisplayString = StringHelper.ColorHighlightColor(actionCountToDisplay);
            dynamicStringPair.Add(new DynamicStringKeyValue("actionTime", actionCountToDisplayString));
            string explosionDamageString = StringHelper.ColorNegativeColor(explosionDamage);
            dynamicStringPair.Add(new DynamicStringKeyValue("explosionDamage", explosionDamageString));
            ...
            allStringPluralRule.Add(new StringPluralRule("hitPlural", actionCount));
