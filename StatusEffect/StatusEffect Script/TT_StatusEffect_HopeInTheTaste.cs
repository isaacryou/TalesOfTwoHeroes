...
{
    public class TT_StatusEffect_HopeInTheTaste : TT_StatusEffect_ATemplate
    {
        ...
        public override void SetUpStatusEffectVariables(int _statusEffectId, Dictionary<string, string> _statusEffectVariables)
        {
            ...
            string healthRestoreAmountString;
            if (_statusEffectVariables.TryGetValue("healthRestoreAmount", out healthRestoreAmountString))
            {
                healthRestoreAmount = int.Parse(healthRestoreAmountString);
            }
            else
            {
        ...
        public override void OnTurnEnd(TT_StatusEffect_Battle _statusEffectBattle, TT_Battle_Object _battleObject, StatusEffectActionPerformed _actionTypePerformed) 
        {
            if (turnCount == 1)
            {
                ...
                _statusEffectBattle.AddStatusEffectToPerform(
                        ...
                        healthRestoreAmount, //Amount of damage/defense/heal ; If none, pass in 0
        ...
        public override string GetStatusEffectDescription()
        {
            ...
            string healthRestoreAmountString = StringHelper.ColorPositiveColor(healthRestoreAmount);
            dynamicStringPair.Add(new DynamicStringKeyValue("challengeTheTasteHpRestoreAmount", healthRestoreAmountString));
