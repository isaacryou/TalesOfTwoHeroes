...
{
    public class TT_StatusEffect_CountingBullet : TT_StatusEffect_ATemplate
    {
        ...
        private int bulletCountReduction;
        ...
        public override void SetUpStatusEffectVariables(int _statusEffectId, Dictionary<string, string> _statusEffectVariables)
        {
            ...
            string bulletCountReductionString;
            if (_statusEffectVariables.TryGetValue("bulletCountReduction", out bulletCountReductionString))
            {
                bulletCountReduction = int.Parse(bulletCountReductionString);
            }
            else
            {
                bulletCountReduction = 0;
            }
        ...
        public override Dictionary<string, string> GetSpecialVariables()
        {
            ...
            allSpecialVariables.Add("bulletCountReduction", bulletCountReduction.ToString());
        ...
        public override void SetSpecialVariables(Dictionary<string, string> _specialVariables)
        {
            ...
            string bulletCountReductionString;
            if (_specialVariables.TryGetValue("bulletCountReduction", out bulletCountReductionString))
            {
                bulletCountReduction = int.Parse(bulletCountReductionString);
            }
        ...
        public override string GetStatusEffectDescription()
        {
            ...
            string bulletCountReductionString = StringHelper.ColorNegativeColor(bulletCountReduction);
            dynamicStringPair.Add(new DynamicStringKeyValue("bulletCountReduction", bulletCountReductionString));
