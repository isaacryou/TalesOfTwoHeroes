...
{
    /*
    public class TT_StatusEffect_Reprieve : TT_StatusEffect_ATemplate
    {
        ...
        private int damagePerConviction;
        ...
        public override void SetUpStatusEffectVariables(int _statusEffectId, Dictionary<string, string> _statusEffectVariables)
        {
            ...
            string damagePerConvictionString;
            if (_statusEffectVariables.TryGetValue("damagePerConviction", out damagePerConvictionString))
            {
                damagePerConviction = int.Parse(damagePerConvictionString);
            }
            else
            {
                damagePerConviction = 0;
            }
        ...
        public override void OnTurnEnd(TT_StatusEffect_Battle _statusEffectBattle, TT_Battle_Object _battleObject, StatusEffectActionPerformed _actionTypePerformed) 
        {
            ...
            if (turnCount == 0)
            {
                ...
                List<GameObject> existingConvictionStatusEffect = npcBattleObject.statusEffectController.GetAllExistingStatusEffectById(61);

                if (existingConvictionStatusEffect != null && existingConvictionStatusEffect.Count > 0)
                {
                    int numberOfConviction = existingConvictionStatusEffect.Count;

                    finalDamage = (numberOfConviction * damagePerConviction);
                }
                ...
                _statusEffectBattle.AddStatusEffectToPerform(
                        ...
                        finalDamage * -1, //Amount of damage/defense/heal ; If none, pass in 0
                        ...
                        100, //Ordinal : Defense = 0 ; Damage = 100 ; Heal = 200 ; Other = 900
                        2, //Pulse live 2d : -1 = None ; 0 = Pulse self ; 1 = Against enemy 
        ...
        public override string GetStatusEffectDescription()
        {
            ...
            dynamicStringPair.Add(new DynamicStringKeyValue("offenseAttack", damagePerConviction.ToString()));
            dynamicStringPair.Add(new DynamicStringKeyValue("turnCount", turnCount.ToString()));
