...
{
    public class TT_StatusEffect_Evil : TT_StatusEffect_ATemplate
    {
        ...
        private int numberOfEvil;
        private float damageIncreasePerStack;
        private int evilPerAction;
        public List<int> evilActions;
        private StatusEffectActionPerformed currentActionPerformed;
        ...
        public override void SetUpStatusEffectVariables(int _statusEffectId, Dictionary<string, string> _statusEffectVariables)
        {
            ...
            numberOfEvil = 0;
            damageIncreasePerStack = statusEffectSerializer.GetFloatValueFromStatusEffect(_statusEffectId, "damageIncreasePerStack");
            evilPerAction = statusEffectSerializer.GetIntValueFromStatusEffect(_statusEffectId, "evilPerAction");

            isRemovable = false;

            evilActions = new List<int>();
        ...
        {
            currentActionPerformed = _actionTypePerformed;
        }
        ...
        {
            float damageIncreaseAmount = numberOfEvil * damageIncreasePerStack;

            //This increasese the damage taken by this unit
        ...
        public override Dictionary<string, string> GetSpecialVariables()
        {
            ...
            allSpecialVariables.Add("numberOfEvil", numberOfEvil.ToString());
        ...
        public override void SetSpecialVariables(Dictionary<string, string> _specialVariables)
        {
            ...
            if (_specialVariables.TryGetValue("numberOfEvil", out evilCountString))
            {
                numberOfEvil = int.Parse(evilCountString);
            }
        ...
        {
            int evilActionTypeId = evilActions[0];
            evilActions.Remove(evilActionTypeId);

            if (evilActionTypeId == (int)_actionTypePerformed)
            {
                int statusEffectOrdinal = _statusEffectBattle.battleController.GetStatusEffectOrdinal(statusEffectId);

                numberOfEvil += evilPerAction;
                ...
                _statusEffectBattle.AddStatusEffectToPerform(
                        ...
                        statusEffectIconSize, //Status effect icon size
        ...
        {
            currentActionPerformed = StatusEffectActionPerformed.None;
        }
        ...
        public override string GetStatusEffectDescription()
        {
            ...
            string damageIncreaseString = StringHelper.ColorNegativeColor(numberOfEvil * damageIncreasePerStack);
            dynamicStringPair.Add(new DynamicStringKeyValue("damageIncrease", damageIncreaseString));
            string numberOfEvilString = StringHelper.ColorHighlightColor(numberOfEvil);
            dynamicStringPair.Add(new DynamicStringKeyValue("evilStackNumber", numberOfEvilString));
