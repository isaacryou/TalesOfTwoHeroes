...
{
    public class TT_StatusEffect_DragoonLoaded : TT_StatusEffect_ATemplate
    {
        ...
        private string dragoonAttackActionName;
        ...
        public override void SetUpStatusEffectVariables(int _statusEffectId, Dictionary<string, string> _statusEffectVariables)
        {
            ...
            dragoonAttackActionName = statusEffectSerializer.GetStringValueFromStatusEffect(_statusEffectId, "dragoonAttackActionName");
            dragoonName = statusEffectSerializer.GetStringValueFromStatusEffect(_statusEffectId, "dragoonName");
        ...
        public override string GetStatusEffectDescription()
        {
            ...
            string dragoonAttackActionNameString = StringHelper.ColorActionName(dragoonAttackActionName);
            dynamicStringPair.Add(new DynamicStringKeyValue("dragoonAttackActionName", dragoonAttackActionNameString));
            string dragoonNameString = StringHelper.ColorArsenalName(dragoonName);
            dynamicStringPair.Add(new DynamicStringKeyValue("dragoonName", dragoonNameString));
