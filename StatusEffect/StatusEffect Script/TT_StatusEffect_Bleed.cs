...
{
    public class TT_StatusEffect_Bleed : TT_StatusEffect_ATemplate
    {
        ...
        private float bleedHealingEffectiveness;
        ...
        public override void SetUpStatusEffectVariables(int _statusEffectId, Dictionary<string, string> _statusEffectVariables)
        {
            ...
            string bleedDamageString;
            if(_statusEffectVariables.TryGetValue("bleedDamage", out bleedDamageString))
            {
                bleedDamage = int.Parse(bleedDamageString);
            }
            else
            {
                bleedDamage = 0;
            ...
            bleedHealingEffectiveness = statusEffectSerializer.GetFloatValueFromStatusEffect(_statusEffectId, "reducedHealing");
        ...
        {
            _statusEffectBattle.statusEffectHealingEffectiveness -= bleedHealingEffectiveness;
        }
        ...
        public override void OnTurnEnd(TT_StatusEffect_Battle _statusEffectBattle, TT_Battle_Object _battleObject, StatusEffectActionPerformed _actionTypePerformed) 
        {
            ...
            _statusEffectBattle.AddStatusEffectToPerform(
                        ...
                        bleedDamage * -1, //Amount of damage/defense/heal ; If none, pass in 0
        ...
        public override string GetStatusEffectDescription()
        {
            ...
            string bleedHealingEffectivenessString = StringHelper.ColorNegativeColor(bleedHealingEffectiveness);
            dynamicStringPair.Add(new DynamicStringKeyValue("reducedHealing", bleedHealingEffectivenessString));
