...
{
    public class TT_StatusEffect_RecordOfAllBeings : TT_StatusEffect_ATemplate
    {
        ...
        public override Dictionary<string, string> GetSpecialVariables()
        {
            ...
            allSpecialVariables.Add("totalDamageTaken", totalDamageTaken.ToString());
        ...
        public override void SetSpecialVariables(Dictionary<string, string> _specialVariables)
        {
            ...
            string totalDamageTakenString;
            if (_specialVariables.TryGetValue("totalDamageTaken", out totalDamageTakenString))
            {
                totalDamageTaken = 0;
            }
        ...
        public override string GetStatusEffectDescription()
        {
            ...
            int absoluteTotalDamageTaken = System.Math.Abs(totalDamageTaken);
            string absoluteTotalDamageTakenString = StringHelper.ColorPositiveColor(absoluteTotalDamageTaken);
            dynamicStringPair.Add(new DynamicStringKeyValue("damageTaken", absoluteTotalDamageTakenString));
