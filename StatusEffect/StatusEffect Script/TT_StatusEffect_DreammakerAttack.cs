...
{
    public class TT_StatusEffect_DreammakerAttack : TT_StatusEffect_ATemplate
    {
        ...
        public override void SetUpStatusEffectVariables(int _statusEffectId, Dictionary<string, string> _statusEffectVariables)
        {
            ...
            {
                attackUp = float.Parse(attackUpString, StringHelper.GetCurrentCultureInfo());
            }
            else
            {
                attackUp = 0;
        ...
        {
            _statusEffectBattle.statusEffectAttackMultiplier += attackUp;
        }
        ...
        public override Dictionary<string, string> GetSpecialVariables()
        {
            ...
            allSpecialVariables.Add("attackUp", attackUp.ToString());
        ...
        public override void SetSpecialVariables(Dictionary<string, string> _specialVariables)
        {
            ...
            string attackUpString;
            if (_specialVariables.TryGetValue("attackUp", out attackUpString))
            {
                attackUp = float.Parse(attackUpString, StringHelper.GetCurrentCultureInfo());
            }
        ...
        public override string GetStatusEffectDescription()
        {
            ...
            string damageIncreasePercentage = (attackUp * 100).ToString();
            dynamicStringPair.Add(new DynamicStringKeyValue("attackDamageIncrease", damageIncreasePercentage));
