...
{
    public class TT_Equipment_ThunderousWhisper : AEquipmentTemplate
    {
        private readonly int EQUIPMENT_ID = 76;
        ...
        public EffectData offenseElectricityEffectData;

        //Equipment variables
        private int offenseAttack;
        private int offenseExtraAttack;
        ...
        public override void InitializeEquipment()
        {
            ...
            offenseExtraAttack = equipmentSerializer.GetIntValueFromEquipment(EQUIPMENT_ID, "offenseExtraAttack");
        ...
        public override void OnAttack(TT_Battle_Object attackerObject, TT_Battle_Object victimObject, TT_StatusEffect_Battle _statusEffectBattle)
        {
            ...
            int finalDamage = offenseAttack;
            if (victimObject.GetCurDefenseValue() > 0)
            {
                finalDamage = offenseExtraAttack;

                AddEffectToEquipmentEffect(offenseElectricityEffectData);
            }
        ...
        public override void OnDefense(TT_Battle_Object defenderObject, TT_Battle_Object victimObject, TT_StatusEffect_Battle _statusEffectBattle)
        {
            ...
            int defenseAmount = (int)(victimObject.GetCurDefenseValue() * defensePercentage);
            defenseAmount = (int)((defenseAmount * _statusEffectBattle.statusEffectDefenseMultiplier) + _statusEffectBattle.statusEffectDefenseFlat);
        ...
        public override void OnUtility(TT_Battle_Object utilityObject, TT_Battle_Object victimObject, TT_StatusEffect_Battle _statusEffectBattle)
        {
            ...
            victimObject.TakeDamage(damageOutput * -1, true, true);
        ...
        public override string GetAttackDescription()
        {
            ...
            string offenseExtraAttackString = StringHelper.ColorNegativeColor(offenseExtraAttack);
            attackStringValuePair.Add(new DynamicStringKeyValue("offenseExtraAttack", offenseExtraAttackString));
        ...
        public override string GetUtilityDescription()
        {
            ...
            string utilityAttackString = StringHelper.ColorNegativeColor(utilityAttack);
            utilityStringValuePair.Add(new DynamicStringKeyValue("utilityAttack", utilityAttackString));
