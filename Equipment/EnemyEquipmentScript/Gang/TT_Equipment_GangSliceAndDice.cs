...
{
    public class TT_Equipment_GangSliceAndDice : AEquipmentTemplate
    {
        private readonly int EQUIPMENT_ID = 121;
        ...
        private int offenseDefenseDamage;
        ...
        public override void InitializeEquipment()
        {
            ...
            offenseDefenseDamage = equipmentSerializer.GetIntValueFromEquipment(EQUIPMENT_ID, "offenseDefenseDamage");
        ...
        public override void OnAttack(TT_Battle_Object attackerObject, TT_Battle_Object victimObject, TT_StatusEffect_Battle _statusEffectBattle)
        {
            ...
            List<GameObject> allExistingNullifyDebuff = new List<GameObject>();
        ...
        IEnumerator ExecuteAttack(TT_Battle_Object attackerObject, TT_Battle_Object victimObject, TT_StatusEffect_Battle _statusEffectBattle, bool _isPlayerAction)
        {
            ...
            int defenseOnlyDamage = (int)((offenseDefenseDamage * _statusEffectBattle.statusEffectAttackMultiplier) + _statusEffectBattle.statusEffectAttackFlat);
            victimObject.TakeDamage(defenseOnlyDamage * -1, true, true);
            ...
            {
                int firstReflectionDamage = _statusEffectBattle.statusEffectDamageToAttacker;
                attackerObject.TakeDamage(firstReflectionDamage * -1, false);
            }
        ...
        public override string GetEquipmentDescription()
        {
            ...
            string offenseDefenseDamageString = StringHelper.ColorNegativeColor(offenseDefenseDamage);
            descriptionStringKeyPair.Add(new DynamicStringKeyValue("offenseDefenseDamage", offenseDefenseDamageString));
