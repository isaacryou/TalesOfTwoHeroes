...
{
    public class TT_Equipment_GangScorchShot : AEquipmentTemplate
    {
        private readonly int EQUIPMENT_ID = 119;
        ...
        public override void InitializeEquipment()
        {
            ...
            offenseDamage = equipmentSerializer.GetIntValueFromEquipment(EQUIPMENT_ID, "offenseAttack");
            burnDamage = equipmentSerializer.GetIntValueFromEquipment(EQUIPMENT_ID, "offenseBurnDamage");
            turnCount = equipmentSerializer.GetIntValueFromEquipment(EQUIPMENT_ID, "offenseBurnTurnCount");
