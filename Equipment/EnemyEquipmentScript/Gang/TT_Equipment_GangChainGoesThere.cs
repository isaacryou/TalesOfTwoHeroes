...
{
    public class TT_Equipment_GangChainGoesThere : AEquipmentTemplate
    {
        private int offenseAttackValue;
        private readonly int EQUIPMENT_ID = 52;
        ...
        public override string GetEquipmentDescription()
        {
            ...
            string bindTurnCountString = StringHelper.ColorHighlightColor(bindTurn);
            descriptionStringKeyPair.Add(new DynamicStringKeyValue("turnCount", bindTurnCountString));
