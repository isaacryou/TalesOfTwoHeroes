...
{
    public class TT_Equipment_RockGolemRockCut : AEquipmentTemplate
    {
        private readonly int EQUIPMENT_ID = 97;
        ...
        public override void InitializeEquipment()
        {
            ...
            reflectionDamage = equipmentSerializer.GetIntValueFromEquipment(EQUIPMENT_ID, "reflectionDamage");
        ...
        public override void OnUtility(TT_Battle_Object utilityObject, TT_Battle_Object victimObject, TT_StatusEffect_Battle _statusEffectBattle)
        {
            ...
            statusEffectDictionary.Add("reflectionDamage", reflectionDamage.ToString());
        ...
        public override string GetEquipmentDescription()
        {
            ...
            string spikeDamageString = StringHelper.ColorNegativeColor(reflectionDamage);
