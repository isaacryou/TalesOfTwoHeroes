...
{
    public class TT_Equipment_RockGolem_MountainStrike : AEquipmentTemplate
    {
        private readonly int EQUIPMENT_ID = 124;
        ...
        public override void OnAttack(TT_Battle_Object attackerObject, TT_Battle_Object victimObject, TT_StatusEffect_Battle _statusEffectBattle)
        {
            ...
            bool damageToDefenseOnly = false;
            if (victimObject.GetCurDefenseValue() > 0)
            {
                damageToDefenseOnly = true;
            }
            ...
            victimObject.TakeDamage(damageOutput * -1, true, damageToDefenseOnly);
        ...
        public override string GetEquipmentDescription()
        {
            ...
            descriptionStringKeyPair.Add(new DynamicStringKeyValue("offenseAttack", attackDamageString));
