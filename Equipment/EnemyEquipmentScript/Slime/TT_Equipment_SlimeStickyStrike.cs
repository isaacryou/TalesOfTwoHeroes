...
{
    public class TT_Equipment_SlimeStickyStrike : AEquipmentTemplate
    {
        private readonly int EQUIPMENT_ID = 16;
        ...
        public override void InitializeEquipment()
        {
            ...
            attackDamage = equipmentSerializer.GetIntValueFromEquipment(EQUIPMENT_ID, "offenseDamage");
