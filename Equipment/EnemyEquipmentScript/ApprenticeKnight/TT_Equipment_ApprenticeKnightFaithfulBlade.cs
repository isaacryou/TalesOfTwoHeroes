...
{
    public class TT_Equipment_ApprenticeKnightFaithfulBlade : AEquipmentTemplate
    {
        private readonly int EQUIPMENT_ID = 133;
        ...
        public override string GetEquipmentDescription()
        {
            ...
            string turnCountString = StringHelper.ColorHighlightColor(attackDamageTurnCount);
            secondStringKeyPair.Add(new DynamicStringKeyValue("turnCount", turnCountString));
