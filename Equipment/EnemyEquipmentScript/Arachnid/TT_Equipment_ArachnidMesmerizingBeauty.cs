...
{
    public class TT_Equipment_ArachnidMesmerizingBeauty : AEquipmentTemplate
    {
        private readonly int EQUIPMENT_ID = 140;
        ...
        public override void InitializeEquipment()
        {
            ...
            attackDownValue = equipmentSerializer.GetFloatValueFromEquipment(EQUIPMENT_ID, "damageReductionAmount");
            attackDownTurnCount = equipmentSerializer.GetIntValueFromEquipment(EQUIPMENT_ID, "damageReductionTurn");
        ...
        {
            float waitTime = (_effectNullified) ? nullifiedEffectData.customEffectTime : utilityEffectData.customEffectTime;
        ...
        public override string GetEquipmentDescription()
        {
            ...
            descriptionStringKeyPair.Add(new DynamicStringKeyValue("damageReductionAmount", attackDownPercentageString));
            descriptionStringKeyPair.Add(new DynamicStringKeyValue("damageReductionTurn", attackDownTurnCount.ToString()));
