...
{
    public class TT_Equipment_ArachnidKneel : AEquipmentTemplate
    {
        private readonly int EQUIPMENT_ID = 136;
        ...
        public GameObject arachnidWebStatusEffectObject;
        public int arachnidWebStatusEffectId;
        ...
        public override void OnBattleStart(TT_Battle_Object _battleObject) 
        {
            ...
            _battleObject.ApplyNewStatusEffectByObject(arachnidWebStatusEffectObject, arachnidWebStatusEffectId, statusEffectDictionary);
        }
