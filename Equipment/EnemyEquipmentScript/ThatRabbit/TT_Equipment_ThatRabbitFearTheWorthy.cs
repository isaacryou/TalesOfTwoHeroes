...
{
    public class TT_Equipment_ThatRabbitFearTheWorthy : AEquipmentTemplate
    {
        private readonly int EQUIPMENT_ID = 149;
        ...
        public override void OnAttack(TT_Battle_Object attackerObject, TT_Battle_Object victimObject, TT_StatusEffect_Battle _statusEffectBattle)
        {
            ...
            StartCoroutine(AttackCoroutine(attackerObject, victimObject, _statusEffectBattle, effectNullified, existingNullifyDebuff));
        }

        IEnumerator AttackCoroutine(TT_Battle_Object attackerObject, TT_Battle_Object victimObject, TT_StatusEffect_Battle _statusEffectBattle, bool _effectNullified, GameObject _existingNullifyDebuff)
        {
            ...
            float effectTime = (_effectNullified) ? defenseDownNullifiedEffect.customEffectTime : defenseDownEffect.customEffectTime;
        ...
        public override string GetEquipmentDescription()
        {
            ...
            descriptionStringKeyPair.Add(new DynamicStringKeyValue("corrosionStatusEffectName", corrosionStatusEffectNameColor.ToString()));
