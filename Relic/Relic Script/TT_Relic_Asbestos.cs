...
namespace TT.Relic
{
    public class TT_Relic_Asbestos: TT_Relic_ATemplate
    {
        public int relicId;
        ...
        public override void AddRelicStatusEffect(GameObject _statusEffectParent, TT_Relic_Relic relicScript)
        {
            ...
            int turnDamage = relicFileSerializer.GetIntValueFromRelic(relicId, "turnDamage");
            int selfDamage = relicFileSerializer.GetIntValueFromRelic(relicId, "selfDamage");

            Dictionary<string, string> statusEffectDictionaryVariables = new Dictionary<string, string>();
            statusEffectDictionaryVariables.Add("turnDamage", turnDamage.ToString());
            statusEffectDictionaryVariables.Add("selfDamage", selfDamage.ToString());
        ...
        public override string GetRelicDescription()
        {
            ...
            dynamicStringPair.Add(new DynamicStringKeyValue("turnDamage", turnDamageString));
