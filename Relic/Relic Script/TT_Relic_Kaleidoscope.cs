...
namespace TT.Relic
{
    public class TT_Relic_Kaleidoscope: TT_Relic_ATemplate
    {
        public int relicId;
        ...
        public override void AddRelicStatusEffect(GameObject _statusEffectParent, TT_Relic_Relic relicScript)
        {
            ...
            int defenseAmount = relicFileSerializer.GetIntValueFromRelic(relicId, "defenseAmount");

            Dictionary<string, string> statusEffectDictionaryVariables = new Dictionary<string, string>();
            statusEffectDictionaryVariables.Add("defenseUp", defenseAmount.ToString());
        ...
        public override string GetRelicDescription()
        {
            RelicXMLFileSerializer relicFileSerializer = new RelicXMLFileSerializer();
            int defenseAmount = relicFileSerializer.GetIntValueFromRelic(relicId, "defenseAmount");
            string defenseAmountString = StringHelper.ColorPositiveColor(defenseAmount);

            List<DynamicStringKeyValue> dynamicStringPair = new List<DynamicStringKeyValue>();
            dynamicStringPair.Add(new DynamicStringKeyValue("defenseAmount", defenseAmountString));
