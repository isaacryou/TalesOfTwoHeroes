...
namespace TT.Relic
{
    public class TT_Relic_Compass : TT_Relic_ATemplate
    {
        public int relicId;
        ...
        {
            RelicXMLFileSerializer relicFileSerializer = new RelicXMLFileSerializer();
            int maxGuidanceAmount = relicFileSerializer.GetIntValueFromRelic(relicId, "maxGuidanceAmount");
            string maxGuidanceAmountString = StringHelper.ColorPositiveColor(maxGuidanceAmount);

            List<DynamicStringKeyValue> dynamicStringPair = new List<DynamicStringKeyValue>();
            dynamicStringPair.Add(new DynamicStringKeyValue("maxGuidanceAmount", maxGuidanceAmountString));
        ...
        public override void OnRelicAcquisition(TT_Player_Player _player, bool _isFirstAcquisition) 
        {
            ...
            _player.PerformMaxGuidanceTransaction(maxGuidanceAmount);
        }
