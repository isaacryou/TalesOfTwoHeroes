...
namespace TT.Relic
{
    public class TT_Relic_HolyWords : TT_Relic_ATemplate
    {
        public int relicId;
        ...
        {
            RelicXMLFileSerializer relicFileSerializer = new RelicXMLFileSerializer();
            int guidanceAmount = relicFileSerializer.GetIntValueFromRelic(relicId, "guidanceAmount");
            string guidanceAmountString = StringHelper.ColorPositiveColor(guidanceAmount);

            List<DynamicStringKeyValue> dynamicStringPair = new List<DynamicStringKeyValue>();
            dynamicStringPair.Add(new DynamicStringKeyValue("guidanceAmount", guidanceAmountString));
        ...
        public override Dictionary<string, string> GetSpecialVariables() {
            ...
            RelicXMLFileSerializer relicFileSerializer = new RelicXMLFileSerializer();
            int guidanceAmount = relicFileSerializer.GetIntValueFromRelic(relicId, "guidanceAmount");
            specialVariables.Add("guidanceAmount", guidanceAmount.ToString());
