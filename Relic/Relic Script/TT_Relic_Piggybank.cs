...
namespace TT.Relic
{
    public class TT_Relic_Piggybank: TT_Relic_ATemplate
    {
        public int relicId;
        ...
        public override void AddRelicStatusEffect(GameObject _statusEffectParent, TT_Relic_Relic relicScript)
        {
            ...
            float rewardIncrease = relicFileSerializer.GetFloatValueFromRelic(relicId, "rewardIncrease");

            Dictionary<string, string> statusEffectDictionaryVariables = new Dictionary<string, string>();
            statusEffectDictionaryVariables.Add("rewardIncrease", rewardIncrease.ToString());
        ...
        public override string GetRelicDescription()
        {
            RelicXMLFileSerializer relicFileSerializer = new RelicXMLFileSerializer();
            float rewardIncrease = relicFileSerializer.GetFloatValueFromRelic(relicId, "rewardIncrease");
            string rewardIncreaseString = StringHelper.ColorPositiveColor(rewardIncrease);

            List<DynamicStringKeyValue> dynamicStringPair = new List<DynamicStringKeyValue>();
            dynamicStringPair.Add(new DynamicStringKeyValue("rewardIncrease", rewardIncreaseString));
