...
namespace TT.Relic
{
    public class TT_Relic_AntiqueMusicSheet : TT_Relic_ATemplate
    {
        public int relicId;
        ...
        public override void AddRelicStatusEffect(GameObject _statusEffectParent, TT_Relic_Relic relicScript)
        {
            ...
            int neededTurnCount = relicFileSerializer.GetIntValueFromRelic(relicId, "neededTurnCount");
            int choiceNumber = relicFileSerializer.GetIntValueFromRelic(relicId, "choiceNumber");

            Dictionary<string, string> statusEffectDictionaryVariables = new Dictionary<string, string>();
            statusEffectDictionaryVariables.Add("neededTurnCount", neededTurnCount.ToString());
            statusEffectDictionaryVariables.Add("choiceNumber", choiceNumber.ToString());
        ...
        public override string GetRelicDescription()
        {
            RelicXMLFileSerializer relicFileSerializer = new RelicXMLFileSerializer();
            int neededTurnCount = relicFileSerializer.GetIntValueFromRelic(relicId, "neededTurnCount");
            string neededTurnCountString = StringHelper.ColorHighlightColor(neededTurnCount);
            int choiceNumber = relicFileSerializer.GetIntValueFromRelic(relicId, "choiceNumber");
            string choiceNumberString = StringHelper.ColorHighlightColor(choiceNumber);

            List<DynamicStringKeyValue> dynamicStringPair = new List<DynamicStringKeyValue>();
            dynamicStringPair.Add(new DynamicStringKeyValue("neededTurnCount", neededTurnCountString));
            dynamicStringPair.Add(new DynamicStringKeyValue("choiceNumber", choiceNumberString));
            ...
            allStringPluralRule.Add(new StringPluralRule("turnPlural", neededTurnCount));
        ...
        public override Dictionary<string, string> GetSpecialVariables()
        {
            ...
            GameObject antiqueMusicSheetStatusEffectObject = playerBattleScript.statusEffectController.GetExistingStatusEffect(78);
            if (antiqueMusicSheetStatusEffectObject == null)
            {
            ...
            return antiqueMusicSheetStatusEffect.GetSpecialVariables(); 
        }
        ...
        public override void SetSpecialVariables(Dictionary<string, string> _specialVariables)
        {
            ...
            antiqueMusicSheetStatusEffect.SetSpecialVariables(_specialVariables);
        }
