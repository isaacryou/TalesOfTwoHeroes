...
namespace TT.Relic
{
    public class TT_Relic_BankStatement : TT_Relic_ATemplate
    {
        public int relicId;
        ...
        public override void AddRelicStatusEffect(GameObject _statusEffectParent, TT_Relic_Relic relicScript)
        {
            ...
            float goldAmount = relicFileSerializer.GetFloatValueFromRelic(relicId, "goldAmount");

            Dictionary<string, string> statusEffectDictionaryVariables = new Dictionary<string, string>();
            statusEffectDictionaryVariables.Add("goldAmountPercentage", goldAmount.ToString());
        ...
        public override string GetRelicDescription()
        {
            ...
            dynamicStringPair.Add(new DynamicStringKeyValue("goldAmountPercentage", goldAmountString));
