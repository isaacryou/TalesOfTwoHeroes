...
namespace TT.Relic
{
    public class TT_Relic_Fabricator : TT_Relic_ATemplate
    {
        public int relicId;
        ...
        public override void AddRelicStatusEffect(GameObject _statusEffectParent, TT_Relic_Relic relicScript)
        {
            ...
            int turnStartDefense = relicFileSerializer.GetIntValueFromRelic(relicId, "turnStartDefense");

            Dictionary<string, string> statusEffectDictionaryVariables = new Dictionary<string, string>();
            statusEffectDictionaryVariables.Add("turnStartDefense", turnStartDefense.ToString());
        ...
        public override string GetRelicDescription()
        {
            RelicXMLFileSerializer relicFileSerializer = new RelicXMLFileSerializer();
            int turnStartDefense = relicFileSerializer.GetIntValueFromRelic(relicId, "turnStartDefense");
            string turnStartDefenseString = StringHelper.ColorPositiveColor(turnStartDefense);

            List<DynamicStringKeyValue> dynamicStringPair = new List<DynamicStringKeyValue>();
            dynamicStringPair.Add(new DynamicStringKeyValue("turnStartDefense", turnStartDefenseString));
