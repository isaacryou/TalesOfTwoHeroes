...
namespace TT.Relic
{
    public class TT_Relic_Helmet : TT_Relic_ATemplate
    {
        public int relicId;
        ...
        public override void AddRelicStatusEffect(GameObject _statusEffectParent, TT_Relic_Relic relicScript)
        {
            ...
            int defenseDefend = relicFileSerializer.GetIntValueFromRelic(relicId, "defenseDefend");

            Dictionary<string, string> statusEffectDictionaryVariables = new Dictionary<string, string>();
            statusEffectDictionaryVariables.Add("defenseDefend", defenseDefend.ToString());
