...
namespace TT.Relic
{
    public class TT_Relic_VoodooMask : TT_Relic_ATemplate
    {
        public int relicId;
        ...
        public override string GetRelicDescription()
        {
            ...
            string damageReductionPercentage = StringHelper.ColorPositiveColor(damageReduction);
            List<DynamicStringKeyValue> dynamicStringPair = new List<DynamicStringKeyValue>();
            dynamicStringPair.Add(new DynamicStringKeyValue("damageResistanceAmount", damageReductionPercentage));
