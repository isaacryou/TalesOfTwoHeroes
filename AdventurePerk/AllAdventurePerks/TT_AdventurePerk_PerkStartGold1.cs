...
{
    public class TT_AdventurePerk_PerkStartGold1 : TT_AdventurePerk_AdventuerPerkScriptTemplate
    {
        ...
        public override void InitializePerk(AdventurePerkXMLFileSerializer adventurePerkFile)
        {
            ...
            goldUpAmount = adventurePerkFile.GetIntValueFromAdventurePerk(adventurePerkId, "goldUpAmount");
        }

        public override void OnAdventureStart(TT_Player_Player _darkPlayer, TT_Player_Player _lightPlayer)
        {
            _darkPlayer.PerformShopCurrencyTransaction(goldUpAmount, false);

            _lightPlayer.PerformShopCurrencyTransaction(goldUpAmount, false);
        }
        ...
        public override string GetPerkDescription(bool _inMiddleOfAdventure = false, TT_Board_Board _mainBoard = null)
        {
            ...
            allDynamicStringKeyValue.Add(new DynamicStringKeyValue("goldIncrease", goldUpAmount.ToString()));
