...
{
    public class TT_AdventurePerk_PerkRestGold1 : TT_AdventurePerk_AdventuerPerkScriptTemplate
    {
        ...
        public override void InitializePerk(AdventurePerkXMLFileSerializer adventurePerkFile)
        {
            ...
            goldUpAmount = adventurePerkFile.GetIntValueFromAdventurePerk(adventurePerkId, "goldAmount");
        }
        ...
        public override void OnNodeComplete(TT_Player_Player _darkPlayer, TT_Player_Player _lightPlayer, TT_Board_Board _mainBoard)
        {
            ...
            playerToRest.PerformShopCurrencyTransaction(goldUpAmount, false);

            _mainBoard.goldToGainOnBreak = goldUpAmount;
        }
        ...
        public override string GetPerkDescription(bool _inMiddleOfAdventure = false, TT_Board_Board _mainBoard = null)
        {
            ...
            allDynamicStringKeyValue.Add(new DynamicStringKeyValue("goldAmount", goldUpAmount.ToString()));
