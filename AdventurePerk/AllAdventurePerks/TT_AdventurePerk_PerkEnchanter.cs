...
{
    public class TT_AdventurePerk_PerkEnchanter : TT_AdventurePerk_AdventuerPerkScriptTemplate
    {
        ...
        private float enchantIncraseChance;
        ...
        public override void InitializePerk(AdventurePerkXMLFileSerializer adventurePerkFile)
        {
            ...
            enchantIncraseChance = adventurePerkFile.GetFloatValueFromAdventurePerk(adventurePerkId, "enchantIncraseChance");
        }
        ...
        public override string GetPerkDescription(bool _inMiddleOfAdventure = false, TT_Board_Board _mainBoard = null)
        {
            ...
            string enchantIncraseChanceString = (enchantIncraseChance * 100).ToString();
            allDynamicStringKeyValue.Add(new DynamicStringKeyValue("enchantIncraseChance", enchantIncraseChanceString));
        ...
        public override Dictionary<string, string> GetSpecialVariables()
        {
            ...
            specialVariable.Add("enchantIncraseChance", enchantIncraseChance.ToString());
