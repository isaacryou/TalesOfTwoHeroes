...
{
    public class TT_AdventurePerk_PerkClairovoyance : TT_AdventurePerk_AdventuerPerkScriptTemplate
    {
        ...
        private int futureSectionNumber;
        ...
        public override void InitializePerk(AdventurePerkXMLFileSerializer adventurePerkFile)
        {
            ...
            futureSectionNumber = adventurePerkFile.GetIntValueFromAdventurePerk(adventurePerkId, "futureSectionNumber");
        }
        ...
        public override string GetPerkDescription(bool _inMiddleOfAdventure = false, TT_Board_Board _mainBoard = null)
        {
            ...
            allDynamicStringKeyValue.Add(new DynamicStringKeyValue("futureSectionNumber", futureSectionNumber.ToString()));

            string dynamicDescription = StringHelper.SetDynamicString(perkDescription, allDynamicStringKeyValue);

            List<StringPluralRule> allStringPluralRule = new List<StringPluralRule>();
            allStringPluralRule.Add(new StringPluralRule("sectionPlural", futureSectionNumber));
        ...
        public override Dictionary<string, string> GetSpecialVariables()
        {
            ...
            specialVariable.Add("futureSectionNumber", futureSectionNumber.ToString());
