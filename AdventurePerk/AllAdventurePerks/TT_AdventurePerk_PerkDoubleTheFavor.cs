...
{
    public class TT_AdventurePerk_PerkDoubleTheFavor : TT_AdventurePerk_AdventuerPerkScriptTemplate
    {
        ...
        private float doubleRelicChance;
        ...
        public override void InitializePerk(AdventurePerkXMLFileSerializer adventurePerkFile)
        {
            ...
            doubleRelicChance = adventurePerkFile.GetFloatValueFromAdventurePerk(adventurePerkId, "doubleRelicChance");
        }
        ...
        public override string GetPerkDescription(bool _inMiddleOfAdventure = false, TT_Board_Board _mainBoard = null)
        {
            ...
            string doubleRelicChanceString = (doubleRelicChance * 100).ToString();
            allDynamicStringKeyValue.Add(new DynamicStringKeyValue("doubleChance", doubleRelicChanceString));
        ...
        public override Dictionary<string, string> GetSpecialVariables()
        {
            ...
            specialVariable.Add("doubleRelicChance", doubleRelicChance.ToString());
