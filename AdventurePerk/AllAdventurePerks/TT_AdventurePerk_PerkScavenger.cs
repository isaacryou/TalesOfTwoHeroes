...
{
    public class TT_AdventurePerk_PerkScavenger : TT_AdventurePerk_AdventuerPerkScriptTemplate
    {
        ...
        public override void InitializePerk(AdventurePerkXMLFileSerializer adventurePerkFile)
        {
            ...
            goldIncrease = adventurePerkFile.GetFloatValueFromAdventurePerk(adventurePerkId, "goldIncrease");
        }
        ...
        public override string GetPerkDescription(bool _inMiddleOfAdventure = false, TT_Board_Board _mainBoard = null)
        {
            ...
            string increaseGoldIncreaseString = (goldIncrease * 100).ToString();
            allDynamicStringKeyValue.Add(new DynamicStringKeyValue("goldIncrease", increaseGoldIncreaseString));
        ...
        public override Dictionary<string, string> GetSpecialVariables()
        {
            ...
            specialVariable.Add("goldIncrease", goldIncrease.ToString());
