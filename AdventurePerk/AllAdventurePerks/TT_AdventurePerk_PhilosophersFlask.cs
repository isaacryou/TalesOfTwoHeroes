...
{
    public class TT_AdventurePerk_PhilosophersFlask : TT_AdventurePerk_AdventuerPerkScriptTemplate
    {
        ...
        private int potionSlotIncrease;
        ...
        public override void InitializePerk(AdventurePerkXMLFileSerializer adventurePerkFile)
        {
            ...
            potionSlotIncrease = adventurePerkFile.GetIntValueFromAdventurePerk(adventurePerkId, "potionSlotIncrease");
        }

        public override void OnAdventureStart(TT_Player_Player _darkPlayer, TT_Player_Player _lightPlayer)
        {
            _darkPlayer.potionController.IncreasePotionSlot(potionSlotIncrease);

            _lightPlayer.potionController.IncreasePotionSlot(potionSlotIncrease);
        }
        ...
        public override string GetPerkDescription(bool _inMiddleOfAdventure = false, TT_Board_Board _mainBoard = null)
        {
            ...
            allDynamicStringKeyValue.Add(new DynamicStringKeyValue("potionSlotIncrease", potionSlotIncrease.ToString()));
