...
{
    public class TT_AdventurePerk_PerkMasterOfArms : TT_AdventurePerk_AdventuerPerkScriptTemplate
    {
        ...
        private int arsenalRewardChoiceIncrease;
        ...
        public override void InitializePerk(AdventurePerkXMLFileSerializer adventurePerkFile)
        {
            ...
            arsenalRewardChoiceIncrease = adventurePerkFile.GetIntValueFromAdventurePerk(adventurePerkId, "arsenalRewardChoiceIncrease");
        }
        ...
        public override string GetPerkDescription(bool _inMiddleOfAdventure = false, TT_Board_Board _mainBoard = null)
        {
            ...
            allDynamicStringKeyValue.Add(new DynamicStringKeyValue("arsenalRewardChoiceIncrease", arsenalRewardChoiceIncrease.ToString()));
        ...
        public override Dictionary<string, string> GetSpecialVariables()
        {
            ...
            specialVariable.Add("arsenalRewardChoiceIncrease", arsenalRewardChoiceIncrease.ToString());
