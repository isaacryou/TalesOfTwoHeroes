...
{
    public class TT_AdventurePerk_PerkKinestheticLearner : TT_AdventurePerk_AdventuerPerkScriptTemplate
    {
        ...
        public override void InitializePerk(AdventurePerkXMLFileSerializer adventurePerkFile)
        {
            ...
            guidanceIncrease = adventurePerkFile.GetIntValueFromAdventurePerk(adventurePerkId, "guidanceIncrease");
        }
        ...
        public override string GetPerkDescription(bool _inMiddleOfAdventure = false, TT_Board_Board _mainBoard = null)
        {
            ...
            allDynamicStringKeyValue.Add(new DynamicStringKeyValue("guidanceIncrease", guidanceIncrease.ToString()));
        ...
        public override Dictionary<string, string> GetSpecialVariables()
        {
            ...
            specialVariable.Add("guidanceIncrease", guidanceIncrease.ToString());
