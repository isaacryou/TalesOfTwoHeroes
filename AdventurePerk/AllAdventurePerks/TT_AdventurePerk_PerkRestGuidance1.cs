...
{
    public class TT_AdventurePerk_PerkRestGuidance1 : TT_AdventurePerk_AdventuerPerkScriptTemplate
    {
        ...
        public override void OnNodeComplete(TT_Player_Player _darkPlayer, TT_Player_Player _lightPlayer, TT_Board_Board _mainBoard)
        {
            ...
            playerToRest.PerformGuidanceTransaction(guidanceUpAmount, false);

            _mainBoard.guidanceToGainOnBreak = guidanceUpAmount;
        }
        ...
        public override string GetPerkDescription(bool _inMiddleOfAdventure = false, TT_Board_Board _mainBoard = null)
        {
            ...
            allDynamicStringKeyValue.Add(new DynamicStringKeyValue("guidanceAmount", guidanceUpAmount.ToString()));
