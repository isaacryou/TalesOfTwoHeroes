...
{
    public class TT_AdventurePerk_PerkStartGuidance1 : TT_AdventurePerk_AdventuerPerkScriptTemplate
    {
        ...
        public override void InitializePerk(AdventurePerkXMLFileSerializer adventurePerkFile)
        {
            ...
            guidanceUpAmount = adventurePerkFile.GetIntValueFromAdventurePerk(adventurePerkId, "guidanceUpAmount");
        }

        public override void OnAdventureStart(TT_Player_Player _darkPlayer, TT_Player_Player _lightPlayer)
        {
            _darkPlayer.PerformGuidanceTransaction(guidanceUpAmount, false);

            _lightPlayer.PerformGuidanceTransaction(guidanceUpAmount, false);
        }
        ...
        public override string GetPerkDescription(bool _inMiddleOfAdventure = false, TT_Board_Board _mainBoard = null)
        {
            ...
            allDynamicStringKeyValue.Add(new DynamicStringKeyValue("guidanceIncrease", guidanceUpAmount.ToString()));
