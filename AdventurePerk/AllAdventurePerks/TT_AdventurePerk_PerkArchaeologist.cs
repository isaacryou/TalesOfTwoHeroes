...
{
    public class TT_AdventurePerk_PerkArchaeologist : TT_AdventurePerk_AdventuerPerkScriptTemplate
    {
        ...
        public override void InitializePerk(AdventurePerkXMLFileSerializer adventurePerkFile)
        {
            ...
            relicChance = adventurePerkFile.GetFloatValueFromAdventurePerk(adventurePerkId, "relicChance");
        }
        ...
        public override string GetPerkDescription(bool _inMiddleOfAdventure = false, TT_Board_Board _mainBoard = null)
        {
            ...
            string increaseRelicChanceString = (relicChance * 100).ToString();
            allDynamicStringKeyValue.Add(new DynamicStringKeyValue("relicChance", increaseRelicChanceString));
        ...
        public override Dictionary<string, string> GetSpecialVariables()
        {
            ...
            specialVariable.Add("relicChance", relicChance.ToString());
