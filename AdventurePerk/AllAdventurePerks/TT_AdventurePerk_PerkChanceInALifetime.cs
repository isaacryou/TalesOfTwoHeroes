...
{
    public class TT_AdventurePerk_PerkChanceInALifetime : TT_AdventurePerk_AdventuerPerkScriptTemplate
    {
        ...
        public override void InitializePerk(AdventurePerkXMLFileSerializer adventurePerkFile)
        {
            ...
            bossWeaponWeight = adventurePerkFile.GetIntValueFromAdventurePerk(adventurePerkId, "bossWeaponWeight");
        }
        ...
        public override string GetPerkDescription(bool _inMiddleOfAdventure = false, TT_Board_Board _mainBoard = null)
        {
            ...
            allDynamicStringKeyValue.Add(new DynamicStringKeyValue("bossWeaponWeight", bossWeaponWeight.ToString()));
        ...
        public override Dictionary<string, string> GetSpecialVariables()
        {
            ...
            specialVariable.Add("bossWeaponWeight", bossWeaponWeight.ToString());
