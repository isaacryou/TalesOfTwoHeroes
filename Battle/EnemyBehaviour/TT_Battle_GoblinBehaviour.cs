...
namespace TT.Battle
{
    public class TT_Battle_GoblinBehaviour : TT_Battle_EnemyBehaviour
    {
        ...
        public override GameObject GetEquipmentForBattleTile(TT_Battle_Object _enemyObject, TT_Battle_Object _playerObject, int _turnCount, int _turnActionCount, int _totalActionCount)
        {
            ...
            //Cook The Meat
            randomEquipmentIds.Add(33);
            equipmentWeight.Add(25);
            //Barbaric Bash
            randomEquipmentIds.Add(34);
            equipmentWeight.Add(30);
            //Guard
            randomEquipmentIds.Add(35);
            equipmentWeight.Add(8);
            //Ritual Dance
            randomEquipmentIds.Add(36);
            equipmentWeight.Add(12);
            //Loud Noise
            randomEquipmentIds.Add(117);
            equipmentWeight.Add(10);
            //Skullcrasher
            randomEquipmentIds.Add(32);
