...
namespace TT.Battle
{
    public class TT_Battle_ApprenticeKnightBehaviour : TT_Battle_EnemyBehaviour
    {
        ...
        public override GameObject GetEquipmentForBattleTile(TT_Battle_Object _enemyObject, TT_Battle_Object _playerObject, int _turnCount, int _turnActionCount, int _totalActionCount)
        {
            ...
            //Defensive Position
            randomEquipmentIds.Add(130);
            equipmentWeight.Add(15);
            //Glorious Charge
            randomEquipmentIds.Add(131);
            equipmentWeight.Add(15);
            //Pray
            randomEquipmentIds.Add(132);
            equipmentWeight.Add(5);
            //Faitfhul Blade
            randomEquipmentIds.Add(133);
            equipmentWeight.Add(30);
            //Relentless Strike
            randomEquipmentIds.Add(134);
            equipmentWeight.Add(35);
            //Blinding Light
            //randomEquipmentIds.Add(135);
            //equipmentWeight.Add(0);
        ...
        {
            if (_enemyObject.battleObjectId == 21 && _playerObject.battleObjectId == 4)
            {
                return 16;
            }
